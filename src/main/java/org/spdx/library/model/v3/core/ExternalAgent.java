...
/**
 * This is an external representation of Agent - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalAgent extends Agent  implements IndividualUriValue {
	 ...
	 */
	public ExternalAgent(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalAgent
	 */
	public ExternalAgent(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalAgent(AgentBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	 ...
	 */
	public Agent setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public Agent setCreationInfo(@Nullable CreationInfo creationInfo) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public Agent setSummary(@Nullable String summary) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
