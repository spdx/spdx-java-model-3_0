...
/**
 * This is an external representation of DefinedProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalDefinedProcess extends DefinedProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalDefinedProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalDefinedProcess
	 */
	public ExternalDefinedProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalDefinedProcess(DefinedProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Core.ExternalDefinedProcess";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public DefinedProcess setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
