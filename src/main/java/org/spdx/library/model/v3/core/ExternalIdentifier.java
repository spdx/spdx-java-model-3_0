...
/**
 * A reference to a resource identifier defined outside the scope of SPDX 3 content that 
...
public  class ExternalIdentifier extends ModelObjectV3  {
	...
	/**
	 * Create the ExternalIdentifier with the provided objectUri and default model store
    ...
    /**
	 * Create the ExternalIdentifier specifying the modelStore, objectUri and optional copyManager
	...
	// Getters and Setters
	/**
	 * Gets the identifierLocator collection
	 * @return the identifierLocator collection
	*/
	...
	/**
	 * gets the externalIdentifierType
	...
	/**
	 * sets the externalIdentifierType
	...
	/**
	 * Builder for ExternalIdentifier
	 */
