...
/**
 * This is an external representation of IndividualElement - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalIndividualElement extends IndividualElement  implements IndividualUriValue {
	 ...
	 */
	public ExternalIndividualElement(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalIndividualElement
	 */
	public ExternalIndividualElement(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalIndividualElement(IndividualElementBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Core.ExternalIndividualElement";
	}
