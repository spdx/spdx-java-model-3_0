...
/**
 * This is an external representation of Organization - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalOrganization extends Organization  implements IndividualUriValue {
	 ...
	 */
	public ExternalOrganization(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalOrganization
	 */
	public ExternalOrganization(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalOrganization(OrganizationBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Core.ExternalOrganization";
	}
