...
/**
 * This is an external representation of Specification - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalSpecification extends Specification  implements IndividualUriValue {
	 ...
	 */
	public ExternalSpecification(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalSpecification
	 */
	public ExternalSpecification(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalSpecification(SpecificationBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Core.ExternalSpecification";
	}
