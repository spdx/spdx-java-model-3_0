...
/**
 * This is an external representation of Tool - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalTool extends Tool  implements IndividualUriValue {
	 ...
	 */
	public ExternalTool(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalTool
	 */
	public ExternalTool(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalTool(ToolBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	 ...
	 */
	public Tool setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
