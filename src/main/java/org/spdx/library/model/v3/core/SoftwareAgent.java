...
public  class SoftwareAgent extends Agent  {
	...
	/**
	 * Create the SoftwareAgent with the provided objectUri and default model store
	...
	/**
	 * Create the SoftwareAgent specifying the modelStore, objectUri and optional copyManager
	...
	public SoftwareAgent(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	public static class SoftwareAgentBuilder extends AgentBuilder {
		 ...
		 * @throws InvalidSPDXAnalysisException
		 */
		public SoftwareAgentBuilder(ModelObjectV3 from) throws InvalidSPDXAnalysisException {
		 ...
		 */
		public SoftwareAgentBuilder(ModelObjectV3 from, String objectUri) throws InvalidSPDXAnalysisException {
		 ...
		 */
		public SoftwareAgentBuilder(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager) {
		...
		**/
		public SoftwareAgentBuilder addExternalIdentifier(ExternalIdentifier externalIdentifier) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder addAllExternalIdentifier(Collection<ExternalIdentifier> externalIdentifierCollection) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder addVerifiedUsing(IntegrityMethod verifiedUsing) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder addAllVerifiedUsing(Collection<IntegrityMethod> verifiedUsingCollection) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder addExternalRef(ExternalRef externalRef) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder addAllExternalRef(Collection<ExternalRef> externalRefCollection) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder setExtension(Extension extension) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder setCreationInfo(CreationInfo creationInfo) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder setDescription(String description) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder setComment(String comment) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder setName(String name) {
			super.name = name;
			return this;
		}
		 ...
		 * @return this for chaining
		**/
		public SoftwareAgentBuilder setSummary(String summary) {
