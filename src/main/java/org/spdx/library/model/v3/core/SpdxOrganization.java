 ...
 */
public class SpdxOrganization extends Organization implements IndividualUriValue {

	/**
	 * @throws InvalidSPDXAnalysisException when unable to create the SpdxOrganization
	 */
	public SpdxOrganization() throws InvalidSPDXAnalysisException {
		super(new NullModelStore(), "https://spdx.org/rdf/3.1/terms/Core/SpdxOrganization", null, true, null);
	}
	 ...
	 */
	public SpdxOrganization setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public SpdxOrganization setCreationInfo(@Nullable CreationInfo creationInfo) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("Can not set or modify a property of an Individual type");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public SpdxOrganization setSummary(@Nullable String summary) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("Can not set or modify a property of an Individual type");
	}
	
	@Override
	public String toString() {
		return "SpdxOrganization";
	}
	...
	public boolean equals(Object o) {
		return o instanceof SpdxOrganization;
	}
	
	@Override
	public int hashCode() {
		return "https://spdx.org/rdf/3.1/terms/Core/SpdxOrganization".hashCode();
	}
	
	@Override
	public String getIndividualURI() {
		return "https://spdx.org/rdf/3.1/terms/Core/SpdxOrganization";
	}
}
