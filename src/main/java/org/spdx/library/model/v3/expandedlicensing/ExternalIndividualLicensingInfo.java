...
/**
 * This is an external representation of IndividualLicensingInfo - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalIndividualLicensingInfo extends IndividualLicensingInfo  implements IndividualUriValue {
	 ...
	 */
	public ExternalIndividualLicensingInfo(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalIndividualLicensingInfo
	 */
	public ExternalIndividualLicensingInfo(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalIndividualLicensingInfo(IndividualLicensingInfoBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "ExpandedLicensing.ExternalIndividualLicensingInfo";
	}
