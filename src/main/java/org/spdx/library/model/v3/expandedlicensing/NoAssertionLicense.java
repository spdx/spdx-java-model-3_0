...
public class NoAssertionLicense extends IndividualLicensingInfo implements IndividualUriValue {
	...
	public NoAssertionLicense() throws InvalidSPDXAnalysisException {
		super(new NullModelStore(), "https://spdx.org/rdf/3.1/terms/ExpandedLicensing/NoAssertionLicense", null, true, null);
	}
	...
	@Override
	public int hashCode() {
		return "https://spdx.org/rdf/3.1/terms/ExpandedLicensing/NoAssertionLicense".hashCode();
	}
	
	@Override
	public String getIndividualURI() {
		return "https://spdx.org/rdf/3.1/terms/ExpandedLicensing/NoAssertionLicense";
	}
}
