...
public abstract class SoftwareArtifact extends Artifact  {
	...
	protected SoftwareArtifact(SoftwareArtifactBuilder builder) throws InvalidSPDXAnalysisException {
		...
		setArtifactSize(builder.artifactSize);
	...
	*/
	...
	public SoftwareArtifact setArtifactSize(@Nullable Integer artifactSize) throws InvalidSPDXAnalysisException {
		if (isStrict() && Objects.nonNull(artifactSize) && artifactSize < 0) {
			throw new InvalidSPDXAnalysisException("artifactSize value " + artifactSize + " is less than the minimum 0 in SoftwareArtifact");
		}
		setPropertyValue(SpdxConstantsV3.PROP_ARTIFACT_SIZE, artifactSize);
		return this;
	}
	/**
	...
	public List<String> _verify(Set<String> verifiedIds, String specVersionForVerify, List<IndividualUriValue> profiles) {
		...
		try {
			Optional<Integer> artifactSize = getArtifactSize();
			if (artifactSize.isPresent() && artifactSize.get() < 0) {
				retval.add("artifactSize value " + artifactSize.get() + " is less than the minimum 0 in SoftwareArtifact");
			}
		} catch (InvalidSPDXAnalysisException e) {
			retval.add("Error getting artifactSize for SoftwareArtifact: "+e.getMessage());
		}
		try {
			@SuppressWarnings("unused")
	...
	public static abstract class SoftwareArtifactBuilder extends ArtifactBuilder {
		...
		protected Integer artifactSize = null;
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SoftwareArtifactBuilder setExtension(Extension extension) {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SoftwareArtifactBuilder setArtifactSize(Integer artifactSize) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareArtifactBuilder setIntendedUse(String intendedUse) {
