...
/**
 * This is an external representation of BoundaryCrossingAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalBoundaryCrossingAction extends BoundaryCrossingAction  implements IndividualUriValue {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the BoundaryCrossingAction
	 */
	public ExternalBoundaryCrossingAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalBoundaryCrossingAction
	 */
	public ExternalBoundaryCrossingAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
			boolean create, String idPrefix) throws InvalidSPDXAnalysisException {
			super(modelStore, objectUri, copyManager, create, idPrefix);
	}

	/**
	 * Create the BoundaryCrossingAction from the builder - used in the builder class
	 * @param builder Builder to create the BoundaryCrossingAction from
	 * @throws InvalidSPDXAnalysisException when unable to create the BoundaryCrossingAction
	 */
	 @SuppressWarnings("unchecked")
	protected ExternalBoundaryCrossingAction(BoundaryCrossingActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalBoundaryCrossingAction";
	}
	 ...
	 */
	public BoundaryCrossingAction setSuppliedBy(@Nullable Agent suppliedBy) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setCreationInfo(@Nullable CreationInfo creationInfo) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setIntendedUse(@Nullable String intendedUse) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setDescription(@Nullable String description) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setBuiltTime(@Nullable String builtTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setActionEndTime(@Nullable String actionEndTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the comment
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setComment(@Nullable String comment) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setValidUntilTime(@Nullable String validUntilTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setReleaseTime(@Nullable String releaseTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the name
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setName(@Nullable String name) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the summary
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setSummary(@Nullable String summary) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryCrossingAction setActionStartTime(@Nullable String actionStartTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
