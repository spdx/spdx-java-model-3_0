...
/**
 * This is an external representation of ChangeProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalChangeProcess extends ChangeProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalChangeProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalChangeProcess
	 */
	public ExternalChangeProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalChangeProcess(ChangeProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalChangeProcess";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public ChangeProcess setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
