...
/**
 * This is an external representation of InspectionAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalInspectionAction extends InspectionAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalInspectionAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalInspectionAction
	 */
	public ExternalInspectionAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalInspectionAction(InspectionActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalInspectionAction";
	}
