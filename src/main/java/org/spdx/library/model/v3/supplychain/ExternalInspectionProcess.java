...
/**
 * This is an external representation of InspectionProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalInspectionProcess extends InspectionProcess  implements IndividualUriValue {
	...
	Collection<Location> plannedInspectionLocations = Collections.emptyList();
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the InspectionProcess
	 */
	public ExternalInspectionProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalInspectionProcess
	 */
	public ExternalInspectionProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
			boolean create, String idPrefix) throws InvalidSPDXAnalysisException {
			super(modelStore, objectUri, copyManager, create, idPrefix);
	}

	/**
	 * Create the InspectionProcess from the builder - used in the builder class
	 * @param builder Builder to create the InspectionProcess from
	 * @throws InvalidSPDXAnalysisException when unable to create the InspectionProcess
	 */
	 @SuppressWarnings("unchecked")
	protected ExternalInspectionProcess(InspectionProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalInspectionProcess";
	}
	...
	public Collection<Location> getPlannedInspectionLocations() {
		return plannedInspectionLocations;
	}
	 ...
	 */
	public InspectionProcess setSuppliedBy(@Nullable Agent suppliedBy) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setCreationInfo(@Nullable CreationInfo creationInfo) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setProcessReadiness(@Nullable ProcessReadinessType processReadiness) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setIntendedUse(@Nullable String intendedUse) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setDescription(@Nullable String description) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setBuiltTime(@Nullable String builtTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the comment
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setComment(@Nullable String comment) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setProcessVersion(@Nullable String processVersion) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setValidUntilTime(@Nullable String validUntilTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setReleaseTime(@Nullable String releaseTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setProcessRationale(@Nullable String processRationale) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the name
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setName(@Nullable String name) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the summary
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public InspectionProcess setSummary(@Nullable String summary) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
