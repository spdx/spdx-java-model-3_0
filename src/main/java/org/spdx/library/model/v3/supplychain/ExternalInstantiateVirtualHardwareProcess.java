...
/**
 * This is an external representation of InstantiateVirtualHardwareProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalInstantiateVirtualHardwareProcess extends InstantiateVirtualHardwareProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalInstantiateVirtualHardwareProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalInstantiateVirtualHardwareProcess
	 */
	public ExternalInstantiateVirtualHardwareProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalInstantiateVirtualHardwareProcess(InstantiateVirtualHardwareProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalInstantiateVirtualHardwareProcess";
	}
