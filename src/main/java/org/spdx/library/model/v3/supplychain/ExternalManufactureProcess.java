...
/**
 * This is an external representation of ManufactureProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalManufactureProcess extends ManufactureProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalManufactureProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalManufactureProcess
	 */
	public ExternalManufactureProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalManufactureProcess(ManufactureProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalManufactureProcess";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public ManufactureProcess setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
