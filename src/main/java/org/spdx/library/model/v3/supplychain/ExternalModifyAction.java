...
/**
 * This is an external representation of ModifyAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalModifyAction extends ModifyAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalModifyAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalModifyAction
	 */
	public ExternalModifyAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalModifyAction(ModifyActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalModifyAction";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public ModifyAction setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
