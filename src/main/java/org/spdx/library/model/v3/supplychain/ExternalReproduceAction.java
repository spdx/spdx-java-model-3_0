...
/**
 * This is an external representation of ReproduceAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalReproduceAction extends ReproduceAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalReproduceAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalReproduceAction
	 */
	public ExternalReproduceAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalReproduceAction(ReproduceActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalReproduceAction";
	}
