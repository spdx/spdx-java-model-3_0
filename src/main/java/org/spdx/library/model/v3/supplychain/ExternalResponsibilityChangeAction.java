...
/**
 * This is an external representation of ResponsibilityChangeAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalResponsibilityChangeAction extends ResponsibilityChangeAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalResponsibilityChangeAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalResponsibilityChangeAction
	 */
	public ExternalResponsibilityChangeAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalResponsibilityChangeAction(ResponsibilityChangeActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalResponsibilityChangeAction";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public ResponsibilityChangeAction setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
