...
/**
 * This is an external representation of StorageAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalStorageAction extends StorageAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalStorageAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalStorageAction
	 */
	public ExternalStorageAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalStorageAction(StorageActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalStorageAction";
	}
