...
/**
 * This is an external representation of StorageProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalStorageProcess extends StorageProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalStorageProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalStorageProcess
	 */
	public ExternalStorageProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalStorageProcess(StorageProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalStorageProcess";
	}
