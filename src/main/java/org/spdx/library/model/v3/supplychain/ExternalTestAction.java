...
/**
 * This is an external representation of TestAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalTestAction extends TestAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalTestAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalTestAction
	 */
	public ExternalTestAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalTestAction(TestActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalTestAction";
	}
