...
/**
 * This is an external representation of TestProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalTestProcess extends TestProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalTestProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalTestProcess
	 */
	public ExternalTestProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalTestProcess(TestProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalTestProcess";
	}
