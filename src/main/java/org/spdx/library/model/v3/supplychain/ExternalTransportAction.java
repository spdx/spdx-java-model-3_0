...
/**
 * This is an external representation of TransportAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalTransportAction extends TransportAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalTransportAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalTransportAction
	 */
	public ExternalTransportAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalTransportAction(TransportActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalTransportAction";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public TransportAction setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
