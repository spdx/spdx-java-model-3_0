...
/**
 * This is an external representation of TransportProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalTransportProcess extends TransportProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalTransportProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalTransportProcess
	 */
	public ExternalTransportProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalTransportProcess(TransportProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalTransportProcess";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public TransportProcess setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
