...
import org.spdx.library.model.v3_0.ai.AIPackage;
...
import org.spdx.library.model.v3_0.ai.ExternalAIPackage;
import org.spdx.library.model.v3_0.build.Build;
import org.spdx.library.model.v3_0.build.ExternalBuild;
import org.spdx.library.model.v3_0.core.Agent;
import org.spdx.library.model.v3_0.core.Annotation;
import org.spdx.library.model.v3_0.core.Artifact;
import org.spdx.library.model.v3_0.core.Bom;
import org.spdx.library.model.v3_0.core.Bundle;
...
import org.spdx.library.model.v3_0.core.ExternalAgent;
import org.spdx.library.model.v3_0.core.ExternalAnnotation;
import org.spdx.library.model.v3_0.core.ExternalArtifact;
import org.spdx.library.model.v3_0.core.ExternalBom;
import org.spdx.library.model.v3_0.core.ExternalBundle;
import org.spdx.library.model.v3_0.core.ExternalElement;
import org.spdx.library.model.v3_0.core.ExternalElementCollection;
import org.spdx.library.model.v3_0.core.ExternalIdentifier;
import org.spdx.library.model.v3_0.core.ExternalIndividualElement;
import org.spdx.library.model.v3_0.core.ExternalLifecycleScopedRelationship;
import org.spdx.library.model.v3_0.core.ExternalMap;
import org.spdx.library.model.v3_0.core.ExternalOrganization;
import org.spdx.library.model.v3_0.core.ExternalPerson;
import org.spdx.library.model.v3_0.core.ExternalRef;
import org.spdx.library.model.v3_0.core.ExternalRelationship;
import org.spdx.library.model.v3_0.core.ExternalSoftwareAgent;
import org.spdx.library.model.v3_0.core.ExternalSpdxDocument;
import org.spdx.library.model.v3_0.core.ExternalTool;
import org.spdx.library.model.v3_0.core.Hash;
import org.spdx.library.model.v3_0.core.IndividualElement;
import org.spdx.library.model.v3_0.core.IntegrityMethod;
import org.spdx.library.model.v3_0.core.LifecycleScopedRelationship;
import org.spdx.library.model.v3_0.core.NamespaceMap;
import org.spdx.library.model.v3_0.core.Organization;
import org.spdx.library.model.v3_0.core.PackageVerificationCode;
import org.spdx.library.model.v3_0.core.Person;
...
import org.spdx.library.model.v3_0.core.Relationship;
import org.spdx.library.model.v3_0.core.SoftwareAgent;
import org.spdx.library.model.v3_0.core.SpdxDocument;
import org.spdx.library.model.v3_0.core.Tool;
import org.spdx.library.model.v3_0.dataset.DatasetPackage;
import org.spdx.library.model.v3_0.dataset.ExternalDatasetPackage;
import org.spdx.library.model.v3_0.expandedlicensing.ConjunctiveLicenseSet;
import org.spdx.library.model.v3_0.expandedlicensing.CustomLicense;
import org.spdx.library.model.v3_0.expandedlicensing.CustomLicenseAddition;
import org.spdx.library.model.v3_0.expandedlicensing.DisjunctiveLicenseSet;
import org.spdx.library.model.v3_0.expandedlicensing.ExtendableLicense;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalConjunctiveLicenseSet;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalCustomLicense;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalCustomLicenseAddition;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalDisjunctiveLicenseSet;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalExtendableLicense;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalIndividualLicensingInfo;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalLicense;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalLicenseAddition;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalListedLicense;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalListedLicenseException;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalOrLaterOperator;
import org.spdx.library.model.v3_0.expandedlicensing.ExternalWithAdditionOperator;
import org.spdx.library.model.v3_0.expandedlicensing.IndividualLicensingInfo;
...
import org.spdx.library.model.v3_0.expandedlicensing.ListedLicense;
import org.spdx.library.model.v3_0.expandedlicensing.ListedLicenseException;
import org.spdx.library.model.v3_0.expandedlicensing.OrLaterOperator;
import org.spdx.library.model.v3_0.expandedlicensing.WithAdditionOperator;
import org.spdx.library.model.v3_0.extension.CdxPropertiesExtension;
import org.spdx.library.model.v3_0.extension.CdxPropertyEntry;
import org.spdx.library.model.v3_0.extension.Extension;
import org.spdx.library.model.v3_0.security.CvssV2VulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.CvssV3VulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.CvssV4VulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.EpssVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExploitCatalogVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalCvssV2VulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalCvssV3VulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalCvssV4VulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalEpssVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalExploitCatalogVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalSsvcVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalVexAffectedVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalVexFixedVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalVexNotAffectedVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalVexUnderInvestigationVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalVexVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.ExternalVulnerability;
import org.spdx.library.model.v3_0.security.SsvcVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.VexAffectedVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.VexFixedVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.VexNotAffectedVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.VexUnderInvestigationVulnAssessmentRelationship;
...
import org.spdx.library.model.v3_0.security.Vulnerability;
import org.spdx.library.model.v3_0.simplelicensing.AnyLicenseInfo;
import org.spdx.library.model.v3_0.simplelicensing.ExternalAnyLicenseInfo;
import org.spdx.library.model.v3_0.simplelicensing.ExternalLicenseExpression;
import org.spdx.library.model.v3_0.simplelicensing.ExternalSimpleLicensingText;
import org.spdx.library.model.v3_0.simplelicensing.LicenseExpression;
import org.spdx.library.model.v3_0.simplelicensing.SimpleLicensingText;
import org.spdx.library.model.v3_0.software.ContentIdentifier;
import org.spdx.library.model.v3_0.software.ExternalSbom;
import org.spdx.library.model.v3_0.software.ExternalSnippet;
import org.spdx.library.model.v3_0.software.ExternalSoftwareArtifact;
import org.spdx.library.model.v3_0.software.ExternalSpdxFile;
import org.spdx.library.model.v3_0.software.ExternalSpdxPackage;
import org.spdx.library.model.v3_0.software.Sbom;
import org.spdx.library.model.v3_0.software.Snippet;
import org.spdx.library.model.v3_0.software.SoftwareArtifact;
import org.spdx.library.model.v3_0.software.SpdxFile;
import org.spdx.library.model.v3_0.software.SpdxPackage;
