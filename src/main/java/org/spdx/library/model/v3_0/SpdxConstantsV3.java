...
public class SpdxConstantsV3 {
	...
	public static final String[] ALL_SPDX_CLASSES = {CORE_EXTERNAL_IDENTIFIER_TYPE, A_I_ENERGY_UNIT_TYPE, EXTENSION_CDX_PROPERTIES_EXTENSION, 
			...
			SOFTWARE_SPDX_PACKAGE, SOFTWARE_EXTERNAL_SPDX_PACKAGE, DATASET_DATASET_TYPE, 
			EXPANDED_LICENSING_EXTENDABLE_LICENSE, EXPANDED_LICENSING_EXTERNAL_EXTENDABLE_LICENSE, 
			CORE_INDIVIDUAL_ELEMENT, CORE_EXTERNAL_INDIVIDUAL_ELEMENT, EXPANDED_LICENSING_INDIVIDUAL_LICENSING_INFO, 
			...
			EXPANDED_LICENSING_NONE_LICENSE, CORE_SPDX_ORGANIZATION, EXTERNAL_ELEMENT, 
			EXTERNAL_CUSTOM_LICENSE, EXTERNAL_CUSTOM_LICENSE_ADDITION};
}
