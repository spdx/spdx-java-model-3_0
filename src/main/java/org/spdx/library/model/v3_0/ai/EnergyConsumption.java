...
public  class EnergyConsumption extends ModelObjectV3  {
	...
	/**
	 * Create the EnergyConsumption with the provided objectUri and default model store
	...
	/**
	 * Create the EnergyConsumption specifying the modelStore, objectUri and optional copyManager
	...
	// Getters and Setters
	/**
	 * Gets the trainingEnergyConsumption collection
	 * @return the trainingEnergyConsumption collection
	*/
	public Collection<EnergyConsumptionDescription> getTrainingEnergyConsumptions() {
		return trainingEnergyConsumptions;
	}
	/**
	 * Gets the finetuningEnergyConsumption collection
	 * @return the finetuningEnergyConsumption collection
	*/
	public Collection<EnergyConsumptionDescription> getFinetuningEnergyConsumptions() {
		return finetuningEnergyConsumptions;
	}
	/**
	 * Gets the inferenceEnergyConsumption collection
	 * @return the inferenceEnergyConsumption collection
	*/
