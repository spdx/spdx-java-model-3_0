...
/**
 * This is an external representation of Bom - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalBom extends Bom  implements IndividualUriValue {
	 ...
	 */
	public ExternalBom(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalBom
	 */
	public ExternalBom(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalBom(BomBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	 ...
	 */
	public Bom setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
