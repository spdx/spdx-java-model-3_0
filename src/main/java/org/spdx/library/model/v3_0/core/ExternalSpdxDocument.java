...
/**
 * This is an external representation of SpdxDocument - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalSpdxDocument extends SpdxDocument  implements IndividualUriValue {
	 ...
	 */
	public ExternalSpdxDocument(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalSpdxDocument
	 */
	public ExternalSpdxDocument(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalSpdxDocument(SpdxDocumentBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Core.ExternalSpdxDocument";
	}
	 ...
	 */
	public SpdxDocument setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
