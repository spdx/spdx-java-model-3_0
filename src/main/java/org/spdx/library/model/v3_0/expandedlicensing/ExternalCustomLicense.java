...
/**
 * This is an external representation of CustomLicense - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalCustomLicense extends CustomLicense  implements IndividualUriValue {
	 ...
	 */
	public ExternalCustomLicense(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalCustomLicense
	 */
	public ExternalCustomLicense(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalCustomLicense(CustomLicenseBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	 ...
	 */
	public CustomLicense setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
