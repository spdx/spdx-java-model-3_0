...
/**
 * This is an external representation of ExtendableLicense - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalExtendableLicense extends ExtendableLicense  implements IndividualUriValue {
	 ...
	 */
	public ExternalExtendableLicense(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalExtendableLicense
	 */
	public ExternalExtendableLicense(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalExtendableLicense(ExtendableLicenseBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "ExpandedLicensing.ExternalExtendableLicense";
	}
	 ...
	 */
	public ExtendableLicense setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
