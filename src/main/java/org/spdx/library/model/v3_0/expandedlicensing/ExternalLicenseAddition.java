...
/**
 * This is an external representation of LicenseAddition - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalLicenseAddition extends LicenseAddition  implements IndividualUriValue {
	 ...
	 */
	public ExternalLicenseAddition(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalLicenseAddition
	 */
	public ExternalLicenseAddition(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalLicenseAddition(LicenseAdditionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "ExpandedLicensing.ExternalLicenseAddition";
	}
	 ...
	 */
	public LicenseAddition setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
