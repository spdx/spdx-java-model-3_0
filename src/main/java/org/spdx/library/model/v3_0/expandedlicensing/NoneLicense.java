...
/**
 * An Individual Value for License where the SPDX data creator determines that no license 
 * is present. 
 */
public class NoneLicense extends IndividualLicensingInfo implements IndividualUriValue {

	/**
	 * @throws InvalidSPDXAnalysisException when unable to create the NoneLicense
	 */
	public NoneLicense() throws InvalidSPDXAnalysisException {
		super(new NullModelStore(), "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/NoneLicense", null, true, null);
	}
	...
	public String getType() {
		return "ExpandedLicensing.NoneLicense";
	}
	 ...
	 */
	public NoneLicense setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public NoneLicense setCreationInfo(@Nullable CreationInfo creationInfo) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("Can not set or modify a property of an Individual type");
	}
		/**
	 * @return the name
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public NoneLicense setDescription(@Nullable String description) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("Can not set or modify a property of an Individual type");
	}
		/**
	 * @return the comment
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public NoneLicense setComment(@Nullable String comment) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("Can not set or modify a property of an Individual type");
	}
		/**
	 * @return the summary
	...
	public boolean equals(Object o) {
		return o instanceof NoneLicense;
	}
	
	@Override
	public int hashCode() {
		return "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/NoneLicense".hashCode();
	}
	
	@Override
	public String getIndividualURI() {
		return "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/NoneLicense";
	}
}
