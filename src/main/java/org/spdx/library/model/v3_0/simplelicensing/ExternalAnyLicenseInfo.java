...
/**
 * This is an external representation of AnyLicenseInfo - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalAnyLicenseInfo extends AnyLicenseInfo  implements IndividualUriValue {
	 ...
	 */
	public ExternalAnyLicenseInfo(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalAnyLicenseInfo
	 */
	public ExternalAnyLicenseInfo(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalAnyLicenseInfo(AnyLicenseInfoBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SimpleLicensing.ExternalAnyLicenseInfo";
	}
