...
public  class Sbom extends Bom  {
	...
	/**
	 * Create the Sbom with the provided objectUri and default model store
	...
	/**
	 * Create the Sbom specifying the modelStore, objectUri and optional copyManager
	...
	public Sbom(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
			boolean create, String idPrefix) throws InvalidSPDXAnalysisException {
		super(modelStore, objectUri, copyManager, create, idPrefix);
		if (!isExternal()) {
			sbomTypes = (Collection<SbomType>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.PROP_SBOM_TYPE, SbomType.class);
		}
	}
	...
	// Getters and Setters
	/**
	 * Gets the sbomType collection
	 * @return the sbomType collection
	*/
	...
	public static class SbomBuilder extends BomBuilder {
		...
		protected Collection<SbomType> sbomTypes = new ArrayList<>();
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SbomBuilder setExtension(Extension extension) {
