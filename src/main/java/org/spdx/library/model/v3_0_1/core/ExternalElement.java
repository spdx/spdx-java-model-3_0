...
public class ExternalElement extends Element  implements IndividualUriValue {
	 ...
	 */
	public ExternalElement(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalElement
	 */
	public ExternalElement(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalElement(ElementBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
