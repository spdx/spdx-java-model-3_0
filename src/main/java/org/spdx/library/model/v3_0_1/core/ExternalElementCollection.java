...
/**
 * This is an external representation of ElementCollection - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalElementCollection extends ElementCollection  implements IndividualUriValue {
	 ...
	 */
	public ExternalElementCollection(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalElementCollection
	 */
	public ExternalElementCollection(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalElementCollection(ElementCollectionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Core.ExternalElementCollection";
	}
