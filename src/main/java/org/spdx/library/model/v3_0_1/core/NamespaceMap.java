...
public  class NamespaceMap extends ModelObjectV3  {
	...
	/**
	 * Create the NamespaceMap with the provided objectUri and default model store
	...
	/**
	 * Create the NamespaceMap specifying the modelStore, objectUri and optional copyManager
