...
public  class SpdxDocument extends ElementCollection  {
	...
	/**
	 * Create the SpdxDocument with the provided objectUri and default model store
	...
	/**
	 * Create the SpdxDocument specifying the modelStore, objectUri and optional copyManager
	...
	// Getters and Setters
	/**
	 * Gets the spdxImport collection
	 * @return the spdxImport collection
	*/
	public Collection<ExternalMap> getSpdxImports() {
		return spdxImports;
	}
	/**
	 * Gets the namespaceMap collection
	 * @return the namespaceMap collection
	*/
	...
	public static class SpdxDocumentBuilder extends ElementCollectionBuilder {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SpdxDocumentBuilder setExtension(Extension extension) {
