...
public class SpdxOrganization extends Organization implements IndividualUriValue {
	...
	public SpdxOrganization() throws InvalidSPDXAnalysisException {
		super(new NullModelStore(), "https://spdx.org/rdf/3.0.1/terms/Core/SpdxOrganization", null, true, null);
	}
	...
	@Override
	public int hashCode() {
		return "https://spdx.org/rdf/3.0.1/terms/Core/SpdxOrganization".hashCode();
	}
	
	@Override
	public String getIndividualURI() {
		return "https://spdx.org/rdf/3.0.1/terms/Core/SpdxOrganization";
	}
}
