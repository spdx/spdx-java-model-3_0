...
public  class ContentIdentifier extends IntegrityMethod  {
	...
	/**
	 * Create the ContentIdentifier with the provided objectUri and default model store
	...
	/**
	 * Create the ContentIdentifier specifying the modelStore, objectUri and optional copyManager
	...
	/**
	 * gets the contentIdentifierType
	...
	/**
	 * sets the contentIdentifierType
	...
	/**
	 * gets the contentIdentifierValue
	...
	public @Nullable String getContentIdentifierValue() throws InvalidSPDXAnalysisException {
		...
		/**
	 * sets the contentIdentifierValue
