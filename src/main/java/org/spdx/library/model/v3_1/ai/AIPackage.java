...
public  class AIPackage extends SpdxPackage  {
	...
	/**
	 * Create the AIPackage with the provided objectUri and default model store
	...
	/**
	 * Create the AIPackage specifying the modelStore, objectUri and optional copyManager
	...
	protected AIPackage(AIPackageBuilder builder) throws InvalidSPDXAnalysisException {
		...
		setIsoAutomationLevel(builder.isoAutomationLevel);
	...
	// Getters and Setters
	/**
	 * Gets the hyperparameter collection
	 * @return the hyperparameter collection
	*/
	...
	*/
	...
	/**
	 * Gets the metricDecisionThreshold collection
	 * @return the metricDecisionThreshold collection
	*/
	public Collection<DictionaryEntry> getMetricDecisionThresholds() {
		return metricDecisionThresholds;
	}
	/**
	 * Gets the modelDataPreprocessing collection
	 * @return the modelDataPreprocessing collection
	*/
	public Collection<String> getModelDataPreprocessings() {
		return modelDataPreprocessings;
	}
	/**
	 * Gets the typeOfModel collection
	 * @return the typeOfModel collection
	*/
	public Collection<String> getTypeOfModels() {
		return typeOfModels;
	}
	/**
	 * Gets the domain collection
	 * @return the domain collection
	*/
	public Collection<String> getDomains() {
		return domains;
	}
	/**
	 * Gets the standardCompliance collection
	 * @return the standardCompliance collection
	*/
	public Collection<String> getStandardCompliances() {
		return standardCompliances;
	}
	/**
	 * Gets the modelExplainability collection
	 * @return the modelExplainability collection
	*/
	...
	/**
	 * gets the useSensitivePersonalInformation
	...
	/**
	 * sets the useSensitivePersonalInformation
	...
	public Optional<IsoAutomationLevel> getIsoAutomationLevel() throws InvalidSPDXAnalysisException {
		Optional<Enum<?>> retval = getEnumPropertyValue(SpdxConstantsV3.PROP_ISO_AUTOMATION_LEVEL);
		if (retval.isPresent()) {
			if (!(retval.get() instanceof IsoAutomationLevel)) {
				throw new InvalidSPDXAnalysisException("Incorrect type stored for isoAutomationLevel");
			}
			return (Optional<IsoAutomationLevel>)(Optional<?>)(retval);
		} else {
			return Optional.empty();
		}
	}
	/**
	 * sets the isoAutomationLevel
	...
	public AIPackage setIsoAutomationLevel(@Nullable IsoAutomationLevel isoAutomationLevel) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.PROP_ISO_AUTOMATION_LEVEL, isoAutomationLevel);
		return this;
	}
	/**
	...
	public AIPackage setSourceInfo(@Nullable String sourceInfo) throws InvalidSPDXAnalysisException {
		...
		/**
	 * gets the informationAboutTraining
	...
	/**
	 * sets the informationAboutTraining
	...
	public AIPackage setSummary(@Nullable String summary) throws InvalidSPDXAnalysisException {
		...
		/**
	 * gets the informationAboutApplication
	...
	/**
	 * sets the informationAboutApplication
	...
	public List<String> _verify(Set<String> verifiedIds, String specVersionForVerify, List<IndividualUriValue> profiles) {
		...
		try {
			@SuppressWarnings("unused")
			Optional<IsoAutomationLevel> isoAutomationLevel = getIsoAutomationLevel();
		} catch (InvalidSPDXAnalysisException e) {
			retval.add("Error getting isoAutomationLevel for AIPackage: "+e.getMessage());
		}
		try {
			@SuppressWarnings("unused")
	...
	public static class AIPackageBuilder extends SpdxPackageBuilder {
		...
		protected IsoAutomationLevel isoAutomationLevel = null;
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public AIPackageBuilder setExtension(Extension extension) {
		...
		**/
		...
		/**
		 * Sets the initial value of isoAutomationLevel
		 * @param isoAutomationLevel value to set
		 * @return this for chaining
		**/
		public AIPackageBuilder setIsoAutomationLevel(IsoAutomationLevel isoAutomationLevel) {
			this.isoAutomationLevel = isoAutomationLevel;
			return this;
		}
		 ...
		 * @return this for chaining
		**/
		public AIPackageBuilder setArtifactSize(Integer artifactSize) {
		 ...
		 * @return this for chaining
		**/
		public AIPackageBuilder setIntendedUse(String intendedUse) {
