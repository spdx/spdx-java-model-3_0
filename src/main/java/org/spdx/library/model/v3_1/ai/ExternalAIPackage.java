...
public class ExternalAIPackage extends AIPackage  implements IndividualUriValue {
	...
	/**
	 * @return the isoAutomationLevel
	 */
	 @SuppressWarnings("unchecked")
	public Optional<IsoAutomationLevel> getIsoAutomationLevel() throws InvalidSPDXAnalysisException {
		return Optional.empty();
	}
	/**
	 * @param isoAutomationLevel the isoAutomationLevel to set
	 * @return this to chain setters
	 * @throws InvalidSPDXAnalysisException 
	 */
	public AIPackage setIsoAutomationLevel(@Nullable IsoAutomationLevel isoAutomationLevel) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public AIPackage setArtifactSize(@Nullable Integer artifactSize) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public AIPackage setIntendedUse(@Nullable String intendedUse) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
