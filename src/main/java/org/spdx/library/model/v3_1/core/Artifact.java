...
public abstract class Artifact extends Element  {
	...
	/**
	 * Create the Artifact with the provided objectUri and default model store
	...
	/**
	 * Create the Artifact specifying the modelStore, objectUri and optional copyManager
	...
	// Getters and Setters
	/**
	 * Gets the originatedBy collection
	 * @return the originatedBy collection
	*/
	public Collection<Agent> getOriginatedBys() {
		return originatedBys;
	}
	/**
	 * Gets the supportLevel collection
	 * @return the supportLevel collection
	*/
	public Collection<SupportType> getSupportLevels() {
		return supportLevels;
	}
	/**
	 * Gets the standardName collection
	 * @return the standardName collection
	*/
	...
	public List<String> _verify(Set<String> verifiedIds, String specVersionForVerify, List<IndividualUriValue> profiles) {
		...
		try {
			...
			retval.add("Error getting intendedUse for Artifact: "+e.getMessage());
		}
		try {
	...
	public static abstract class ArtifactBuilder extends ElementBuilder {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public ArtifactBuilder setExtension(Extension extension) {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public ArtifactBuilder setIntendedUse(String intendedUse) {
