...
/**
 * This is an external representation of Action - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalAction extends Action  implements IndividualUriValue {
	 ...
	 */
	public ExternalAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalAction
	 */
	public ExternalAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalAction(ActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
