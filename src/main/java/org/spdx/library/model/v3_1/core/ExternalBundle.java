...
/**
 * This is an external representation of Bundle - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalBundle extends Bundle  implements IndividualUriValue {
	 ...
	 */
	public ExternalBundle(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalBundle
	 */
	public ExternalBundle(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalBundle(BundleBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
