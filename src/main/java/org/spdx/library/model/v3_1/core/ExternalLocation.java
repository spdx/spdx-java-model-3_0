...
/**
 * This is an external representation of Location - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalLocation extends Location  implements IndividualUriValue {
	 ...
	 */
	public ExternalLocation(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalLocation
	 */
	public ExternalLocation(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalLocation(LocationBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
