...
/**
 * This is an external representation of Person - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalPerson extends Person  implements IndividualUriValue {
	 ...
	 */
	public ExternalPerson(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalPerson
	 */
	public ExternalPerson(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalPerson(PersonBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
