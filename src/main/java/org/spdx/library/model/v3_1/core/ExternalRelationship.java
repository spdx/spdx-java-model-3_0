...
/**
 * This is an external representation of Relationship - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalRelationship extends Relationship  implements IndividualUriValue {
	 ...
	 */
	public ExternalRelationship(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalRelationship
	 */
	public ExternalRelationship(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalRelationship(RelationshipBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Core.ExternalRelationship";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public Relationship setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
