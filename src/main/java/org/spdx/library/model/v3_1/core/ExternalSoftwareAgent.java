...
/**
 * This is an external representation of SoftwareAgent - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalSoftwareAgent extends SoftwareAgent  implements IndividualUriValue {
	 ...
	 */
	public ExternalSoftwareAgent(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalSoftwareAgent
	 */
	public ExternalSoftwareAgent(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalSoftwareAgent(SoftwareAgentBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Core.ExternalSoftwareAgent";
	}
	 ...
	 */
	public SoftwareAgent setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public SoftwareAgent setCreationInfo(@Nullable CreationInfo creationInfo) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public SoftwareAgent setSummary(@Nullable String summary) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
