...
/**
 * An Individual Value for Element representing a set of Elements of unknown identity 
...
public class NoAssertionElement extends IndividualElement implements IndividualUriValue {
	...
	public NoAssertionElement() throws InvalidSPDXAnalysisException {
		super(new NullModelStore(), "https://spdx.org/rdf/3.1/terms/Core/NoAssertionElement", null, true, null);
	}
	 ...
	 */
	public NoAssertionElement setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
	...
	@Override
	public int hashCode() {
		return "https://spdx.org/rdf/3.1/terms/Core/NoAssertionElement".hashCode();
	}
	
	@Override
	public String getIndividualURI() {
		return "https://spdx.org/rdf/3.1/terms/Core/NoAssertionElement";
	}
}
