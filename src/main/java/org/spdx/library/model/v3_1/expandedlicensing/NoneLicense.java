...
public class NoneLicense extends IndividualLicensingInfo implements IndividualUriValue {
	...
	public NoneLicense() throws InvalidSPDXAnalysisException {
		super(new NullModelStore(), "https://spdx.org/rdf/3.1/terms/ExpandedLicensing/NoneLicense", null, true, null);
	}
	...
	@Override
	public int hashCode() {
		return "https://spdx.org/rdf/3.1/terms/ExpandedLicensing/NoneLicense".hashCode();
	}
	
	@Override
	public String getIndividualURI() {
		return "https://spdx.org/rdf/3.1/terms/ExpandedLicensing/NoneLicense";
	}
}
