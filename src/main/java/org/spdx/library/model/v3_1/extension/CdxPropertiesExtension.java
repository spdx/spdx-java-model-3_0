...
public  class CdxPropertiesExtension extends Extension  {
	...
	/**
	 * Create the CdxPropertiesExtension with the provided objectUri and default model store
	...
	/**
	 * Create the CdxPropertiesExtension specifying the modelStore, objectUri and optional copyManager
	...
	// Getters and Setters
	/**
	 * Gets the cdxProperty collection
	 * @return the cdxProperty collection
	*/
	...
	/**
	 * Builder for CdxPropertiesExtension
	 */
