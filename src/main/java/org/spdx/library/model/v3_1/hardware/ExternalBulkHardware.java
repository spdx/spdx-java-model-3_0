...
/**
 * This is an external representation of BulkHardware - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalBulkHardware extends BulkHardware  implements IndividualUriValue {
	 ...
	 */
	public ExternalBulkHardware(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalBulkHardware
	 */
	public ExternalBulkHardware(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalBulkHardware(BulkHardwareBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Hardware.ExternalBulkHardware";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BulkHardware setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
