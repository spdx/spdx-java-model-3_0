...
/**
 * This is an external representation of Hardware - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalHardware extends Hardware  implements IndividualUriValue {
	 ...
	 */
	public ExternalHardware(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalHardware
	 */
	public ExternalHardware(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalHardware(HardwareBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Hardware.ExternalHardware";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public Hardware setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
