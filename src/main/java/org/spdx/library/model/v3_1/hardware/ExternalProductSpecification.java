...
/**
 * This is an external representation of ProductSpecification - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalProductSpecification extends ProductSpecification  implements IndividualUriValue {
	 ...
	 */
	public ExternalProductSpecification(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalProductSpecification
	 */
	public ExternalProductSpecification(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalProductSpecification(ProductSpecificationBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Hardware.ExternalProductSpecification";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public ProductSpecification setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
