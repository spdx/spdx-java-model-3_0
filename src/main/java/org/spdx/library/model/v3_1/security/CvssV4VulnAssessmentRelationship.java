...
public  class CvssV4VulnAssessmentRelationship extends VulnAssessmentRelationship  {
	...
	/**
	 * Create the CvssV4VulnAssessmentRelationship with default model store and generated anonymous ID
	...
	/**
	 * Create the CvssV4VulnAssessmentRelationship with the provided objectUri and default model store
	...
	/**
	 * Create the CvssV4VulnAssessmentRelationship specifying the modelStore, objectUri and optional copyManager
	 * @param modelStore Model store where the CvssV4VulnAssessmentRelationship is to be stored
	 * @param objectUri URI or anonymous ID for the CvssV4VulnAssessmentRelationship
	 * @param copyManager Copy manager for the CvssV4VulnAssessmentRelationship - can be null if copying is not required
	 * @param create true if CvssV4VulnAssessmentRelationship is to be created
	 * @param idPrefix - prefix to be used when generating new SPDX IDs
	 * @throws InvalidSPDXAnalysisException when unable to create the CvssV4VulnAssessmentRelationship
	 */
	 @SuppressWarnings("unchecked")
	public CvssV4VulnAssessmentRelationship(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	/**
	 * Builder for CvssV4VulnAssessmentRelationship
	 */
	public static class CvssV4VulnAssessmentRelationshipBuilder extends VulnAssessmentRelationshipBuilder {
	
		/**
		 * Create an CvssV4VulnAssessmentRelationshipBuilder from another model object copying the modelStore and copyManager and using an anonymous ID
		...
		/**
		 * Create an CvssV4VulnAssessmentRelationshipBuilder from another model object copying the modelStore and copyManager
		 * @param from model object to copy the model store and copyManager from
		...
		/**
		 * Creates a CvssV4VulnAssessmentRelationshipBuilder
		 * @param modelStore model store for the built CvssV4VulnAssessmentRelationship
		 * @param objectUri objectUri for the built CvssV4VulnAssessmentRelationship
		 * @param copyManager optional copyManager for the built CvssV4VulnAssessmentRelationship
		 */
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public CvssV4VulnAssessmentRelationshipBuilder setSecurityAssessedElement(SoftwareArtifact SecurityAssessedElement) {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public CvssV4VulnAssessmentRelationshipBuilder setExtension(Extension extension) {
		...
		**/
		...
		/**
		 * @return the CvssV4VulnAssessmentRelationship
		...
		public CvssV4VulnAssessmentRelationship build() throws InvalidSPDXAnalysisException {
			...
			try {
				return new CvssV4VulnAssessmentRelationship(this);
			} finally {
