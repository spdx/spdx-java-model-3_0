...
/**
 * This is an external representation of CvssV3VulnAssessmentRelationship - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalCvssV3VulnAssessmentRelationship extends CvssV3VulnAssessmentRelationship  implements IndividualUriValue {
	 ...
	 */
	public ExternalCvssV3VulnAssessmentRelationship(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalCvssV3VulnAssessmentRelationship
	 */
	public ExternalCvssV3VulnAssessmentRelationship(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalCvssV3VulnAssessmentRelationship(CvssV3VulnAssessmentRelationshipBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Security.ExternalCvssV3VulnAssessmentRelationship";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CvssV3VulnAssessmentRelationship setSecurityAssessedElement(@Nullable SoftwareArtifact SecurityAssessedElement) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
