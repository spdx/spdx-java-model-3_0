...
public class ExternalCvssV4VulnAssessmentRelationship extends CvssV4VulnAssessmentRelationship  implements IndividualUriValue {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CvssV4VulnAssessmentRelationship setSecurityAssessedElement(@Nullable SoftwareArtifact SecurityAssessedElement) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CvssV4VulnAssessmentRelationship setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
