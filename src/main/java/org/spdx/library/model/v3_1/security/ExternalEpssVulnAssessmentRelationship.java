...
/**
 * This is an external representation of EpssVulnAssessmentRelationship - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalEpssVulnAssessmentRelationship extends EpssVulnAssessmentRelationship  implements IndividualUriValue {
	 ...
	 */
	public ExternalEpssVulnAssessmentRelationship(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalEpssVulnAssessmentRelationship
	 */
	public ExternalEpssVulnAssessmentRelationship(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalEpssVulnAssessmentRelationship(EpssVulnAssessmentRelationshipBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Security.ExternalEpssVulnAssessmentRelationship";
	}
