...
/**
 * This is an external representation of SsvcVulnAssessmentRelationship - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalSsvcVulnAssessmentRelationship extends SsvcVulnAssessmentRelationship  implements IndividualUriValue {
	 ...
	 */
	public ExternalSsvcVulnAssessmentRelationship(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalSsvcVulnAssessmentRelationship
	 */
	public ExternalSsvcVulnAssessmentRelationship(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalSsvcVulnAssessmentRelationship(SsvcVulnAssessmentRelationshipBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Security.ExternalSsvcVulnAssessmentRelationship";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public SsvcVulnAssessmentRelationship setSecurityAssessedElement(@Nullable SoftwareArtifact SecurityAssessedElement) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public SsvcVulnAssessmentRelationship setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
