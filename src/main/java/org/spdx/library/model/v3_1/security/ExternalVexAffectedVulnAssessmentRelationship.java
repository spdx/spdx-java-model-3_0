...
public class ExternalVexAffectedVulnAssessmentRelationship extends VexAffectedVulnAssessmentRelationship  implements IndividualUriValue {
	 ...
	 */
	public ExternalVexAffectedVulnAssessmentRelationship(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalVexAffectedVulnAssessmentRelationship
	 */
	public ExternalVexAffectedVulnAssessmentRelationship(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalVexAffectedVulnAssessmentRelationship(VexAffectedVulnAssessmentRelationshipBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Security.ExternalVexAffectedVulnAssessmentRelationship";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public VexAffectedVulnAssessmentRelationship setSecurityAssessedElement(@Nullable SoftwareArtifact SecurityAssessedElement) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
