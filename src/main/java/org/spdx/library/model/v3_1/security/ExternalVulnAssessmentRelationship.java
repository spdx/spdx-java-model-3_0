...
/**
 * This is an external representation of VulnAssessmentRelationship - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalVulnAssessmentRelationship extends VulnAssessmentRelationship  implements IndividualUriValue {
	 ...
	 */
	public ExternalVulnAssessmentRelationship(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalVulnAssessmentRelationship
	 */
	public ExternalVulnAssessmentRelationship(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalVulnAssessmentRelationship(VulnAssessmentRelationshipBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Security.ExternalVulnAssessmentRelationship";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public VulnAssessmentRelationship setSecurityAssessedElement(@Nullable SoftwareArtifact SecurityAssessedElement) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public VulnAssessmentRelationship setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
