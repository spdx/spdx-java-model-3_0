...
public abstract class VulnAssessmentRelationship extends Relationship  {
	...
	/**
	 * Create the VulnAssessmentRelationship with the provided objectUri and default model store
	...
	/**
	 * Create the VulnAssessmentRelationship specifying the modelStore, objectUri and optional copyManager
	...
	protected VulnAssessmentRelationship(VulnAssessmentRelationshipBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
		setSecurityAssessedElement(builder.SecurityAssessedElement);
	...
	public VulnAssessmentRelationship setFrom(@Nullable Element from) throws InvalidSPDXAnalysisException {
		...
		/**
	 * gets the SecurityAssessedElement
	...
	public Optional<SoftwareArtifact> getSecurityAssessedElement() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstantsV3.PROP_SECURITY_ASSESSED_ELEMENT);
		if (retval.isPresent()) {
			if (!(retval.get() instanceof SoftwareArtifact)) {
				throw new InvalidSPDXAnalysisException("Incorrect type stored for SecurityAssessedElement");
			}
			return (Optional<SoftwareArtifact>)(Optional<?>)(retval);
		} else {
	...
	/**
	 * set the SecurityAssessedElement
	...
	public VulnAssessmentRelationship setSecurityAssessedElement(@Nullable SoftwareArtifact SecurityAssessedElement) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.PROP_SECURITY_ASSESSED_ELEMENT, SecurityAssessedElement);
		return this;
	}
		/**
	 * gets the suppliedBy
	...
	public List<String> _verify(Set<String> verifiedIds, String specVersionForVerify, List<IndividualUriValue> profiles) {
		...
		Optional<SoftwareArtifact> SecurityAssessedElement;
		try {
			SecurityAssessedElement = getSecurityAssessedElement();
			if (SecurityAssessedElement.isPresent()) {
				retval.addAll(SecurityAssessedElement.get().verify(verifiedIds, specVersionForVerify, profiles));
			}
		} catch (InvalidSPDXAnalysisException e) {
			retval.add("Error getting SecurityAssessedElement for VulnAssessmentRelationship: "+e.getMessage());
		}
	...
	/**
	 * Builder for VulnAssessmentRelationship
	 */
	public static abstract class VulnAssessmentRelationshipBuilder extends RelationshipBuilder {
		...
		protected SoftwareArtifact SecurityAssessedElement = null;
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public VulnAssessmentRelationshipBuilder setSecurityAssessedElement(SoftwareArtifact SecurityAssessedElement) {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public VulnAssessmentRelationshipBuilder setExtension(Extension extension) {
