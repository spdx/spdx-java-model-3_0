...
/**
 * This is an external representation of LicenseExpression - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalLicenseExpression extends LicenseExpression  implements IndividualUriValue {

	Collection<ElementMap> customIdToLicenses = Collections.emptyList();
	 ...
	 */
	public ExternalLicenseExpression(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalLicenseExpression
	 */
	public ExternalLicenseExpression(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalLicenseExpression(LicenseExpressionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SimpleLicensing.ExternalLicenseExpression";
	}
	
	// Getters and Setters
	public Collection<ElementMap> getCustomIdToLicenses() {
		return customIdToLicenses;
	}
	 ...
	 */
	public LicenseExpression setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
