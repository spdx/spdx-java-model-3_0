...
public  class LicenseExpression extends AnyLicenseInfo  {
	...
	/**
	 * Create the LicenseExpression with the provided objectUri and default model store
	...
	/**
	 * Create the LicenseExpression specifying the modelStore, objectUri and optional copyManager
	...
	public LicenseExpression(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
		...
		if (!isExternal()) {
			customIdToLicenses = (Collection<ElementMap>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.PROP_CUSTOM_ID_TO_LICENSE, ElementMap.class);
		}
		if (!isExternal()) {
	...
	protected LicenseExpression(LicenseExpressionBuilder builder) throws InvalidSPDXAnalysisException {
		...
		customIdToLicenses = (Collection<ElementMap>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.PROP_CUSTOM_ID_TO_LICENSE, ElementMap.class);
		customIdToUris = (Collection<DictionaryEntry>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.PROP_CUSTOM_ID_TO_URI, DictionaryEntry.class);
		getCustomIdToLicenses().addAll(builder.customIdToLicenses);
	...
	// Getters and Setters
	/**
	 * Gets the customIdToLicense collection
	 * @return the customIdToLicense collection
	*/
	public Collection<ElementMap> getCustomIdToLicenses() {
		return customIdToLicenses;
	}
	/**
	 * Gets the customIdToUri collection
	 * @return the customIdToUri collection
	*/
	...
	public List<String> _verify(Set<String> verifiedIds, String specVersionForVerify, List<IndividualUriValue> profiles) {
		...
		for (ElementMap customIdToLicense:customIdToLicenses) {
			retval.addAll(customIdToLicense.verify(verifiedIds, specVersionForVerify, profiles));
		}
	...
	public static class LicenseExpressionBuilder extends AnyLicenseInfoBuilder {
		...
		protected Collection<ElementMap> customIdToLicenses = new ArrayList<>();
		...
		/**
		 * Adds a customIdToLicense to the initial collection
		 * @param customIdToLicense customIdToLicense to add
		 * @return this for chaining
		**/
		public LicenseExpressionBuilder addCustomIdToLicense(ElementMap customIdToLicense) {
			if (Objects.nonNull(customIdToLicense)) {
				customIdToLicenses.add(customIdToLicense);
			}
			return this;
		}
		
		/**
		 * Adds all elements from a collection to the initial customIdToLicense collection
		 * @param customIdToLicenseCollection collection to initialize the customIdToLicense
		 * @return this for chaining
		**/
		public LicenseExpressionBuilder addAllCustomIdToLicense(Collection<ElementMap> customIdToLicenseCollection) {
			if (Objects.nonNull(customIdToLicenseCollection)) {
				customIdToLicenses.addAll(customIdToLicenseCollection);
			}
			return this;
		}
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public LicenseExpressionBuilder setExtension(Extension extension) {
