...
public class ExternalSnippet extends Snippet  implements IndividualUriValue {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public Snippet setArtifactSize(@Nullable Integer artifactSize) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public Snippet setIntendedUse(@Nullable String intendedUse) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
