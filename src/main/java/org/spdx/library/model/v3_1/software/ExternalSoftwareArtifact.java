...
/**
 * This is an external representation of SoftwareArtifact - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalSoftwareArtifact extends SoftwareArtifact  implements IndividualUriValue {
	 ...
	 */
	public ExternalSoftwareArtifact(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalSoftwareArtifact
	 */
	public ExternalSoftwareArtifact(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalSoftwareArtifact(SoftwareArtifactBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "Software.ExternalSoftwareArtifact";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public SoftwareArtifact setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 */
	public Optional<Integer> getArtifactSize() throws InvalidSPDXAnalysisException {
		return Optional.empty();
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public SoftwareArtifact setArtifactSize(@Nullable Integer artifactSize) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public SoftwareArtifact setIntendedUse(@Nullable String intendedUse) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
