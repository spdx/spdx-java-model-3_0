...
public  class Snippet extends SoftwareArtifact  {
	...
	/**
	 * Create the Snippet with the provided objectUri and default model store
	...
	/**
	 * Create the Snippet specifying the modelStore, objectUri and optional copyManager
	...
	public Snippet(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected Snippet(SnippetBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
		if (Objects.nonNull(builder.snippetFromFile)) {
	...
	/**
	 * gets the snippetFromFile
	 * @return the snippetFromFile
	 */
	 @SuppressWarnings("unchecked")
	public @Nullable SpdxFile getSnippetFromFile() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstantsV3.PROP_SNIPPET_FROM_FILE);
		if (retval.isPresent()) {
	...
	public Snippet setSnippetFromFile(@Nullable SpdxFile snippetFromFile) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsV3.PROP_SNIPPET_FROM_FILE, snippetFromFile);
		return this;
	}
		/**
	 * gets the lineRange
	...
	public Optional<PositiveIntegerRange> getLineRange() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstantsV3.PROP_LINE_RANGE);
		if (retval.isPresent()) {
	...
	public Snippet setLineRange(@Nullable PositiveIntegerRange lineRange) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.PROP_LINE_RANGE, lineRange);
		return this;
	}
		/**
	 * gets the byteRange
	...
	public Optional<PositiveIntegerRange> getByteRange() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstantsV3.PROP_BYTE_RANGE);
		if (retval.isPresent()) {
			if (!(retval.get() instanceof PositiveIntegerRange)) {
	...
	public Snippet setByteRange(@Nullable PositiveIntegerRange byteRange) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.PROP_BYTE_RANGE, byteRange);
		return this;
	}
	/**
	 * sets the extension
	...
	public static class SnippetBuilder extends SoftwareArtifactBuilder {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SnippetBuilder setExtension(Extension extension) {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SnippetBuilder setArtifactSize(Integer artifactSize) {
		 ...
		 * @return this for chaining
		**/
		public SnippetBuilder setIntendedUse(String intendedUse) {
