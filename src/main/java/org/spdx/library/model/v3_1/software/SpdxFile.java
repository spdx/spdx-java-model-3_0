...
public  class SpdxFile extends SoftwareArtifact  {
	...
	/**
	 * Create the SpdxFile with the provided objectUri and default model store
	...
	/**
	 * Create the SpdxFile specifying the modelStore, objectUri and optional copyManager
	...
	public static class SpdxFileBuilder extends SoftwareArtifactBuilder {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SpdxFileBuilder setExtension(Extension extension) {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SpdxFileBuilder setArtifactSize(Integer artifactSize) {
		 ...
		 * @return this for chaining
		**/
		public SpdxFileBuilder setIntendedUse(String intendedUse) {
