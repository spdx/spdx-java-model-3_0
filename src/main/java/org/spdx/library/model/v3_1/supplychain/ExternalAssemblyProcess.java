...
/**
 * This is an external representation of AssemblyProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalAssemblyProcess extends AssemblyProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalAssemblyProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalAssemblyProcess
	 */
	public ExternalAssemblyProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalAssemblyProcess(AssemblyProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalAssemblyProcess";
	}
