...
/**
 * This is an external representation of BoundaryDefinitionProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalBoundaryDefinitionProcess extends BoundaryDefinitionProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalBoundaryDefinitionProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalBoundaryDefinitionProcess
	 */
	public ExternalBoundaryDefinitionProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalBoundaryDefinitionProcess(BoundaryDefinitionProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalBoundaryDefinitionProcess";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public BoundaryDefinitionProcess setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
