...
/**
 * This is an external representation of CreateAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalCreateAction extends CreateAction  implements IndividualUriValue {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the CreateAction
	 */
	public ExternalCreateAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalCreateAction
	 */
	public ExternalCreateAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
			boolean create, String idPrefix) throws InvalidSPDXAnalysisException {
			super(modelStore, objectUri, copyManager, create, idPrefix);
	}

	/**
	 * Create the CreateAction from the builder - used in the builder class
	 * @param builder Builder to create the CreateAction from
	 * @throws InvalidSPDXAnalysisException when unable to create the CreateAction
	 */
	 @SuppressWarnings("unchecked")
	protected ExternalCreateAction(CreateActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalCreateAction";
	}
	 ...
	 */
	public CreateAction setSuppliedBy(@Nullable Agent suppliedBy) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setCreationInfo(@Nullable CreationInfo creationInfo) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setIntendedUse(@Nullable String intendedUse) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setDescription(@Nullable String description) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setBuiltTime(@Nullable String builtTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setActionEndTime(@Nullable String actionEndTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the comment
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setComment(@Nullable String comment) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setValidUntilTime(@Nullable String validUntilTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setReleaseTime(@Nullable String releaseTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the name
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setName(@Nullable String name) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the summary
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setSummary(@Nullable String summary) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public CreateAction setActionStartTime(@Nullable String actionStartTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
