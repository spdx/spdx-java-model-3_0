...
/**
 * This is an external representation of DefinedStateProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalDefinedStateProcess extends DefinedStateProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalDefinedStateProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalDefinedStateProcess
	 */
	public ExternalDefinedStateProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalDefinedStateProcess(DefinedStateProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalDefinedStateProcess";
	}
