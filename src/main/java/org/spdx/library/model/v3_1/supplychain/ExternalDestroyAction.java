...
/**
 * This is an external representation of DestroyAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalDestroyAction extends DestroyAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalDestroyAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalDestroyAction
	 */
	public ExternalDestroyAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalDestroyAction(DestroyActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalDestroyAction";
	}
