...
/**
 * This is an external representation of HarvestAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalHarvestAction extends HarvestAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalHarvestAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalHarvestAction
	 */
	public ExternalHarvestAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalHarvestAction(HarvestActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalHarvestAction";
	}
