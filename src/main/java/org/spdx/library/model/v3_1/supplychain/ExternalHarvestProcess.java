...
/**
 * This is an external representation of HarvestProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalHarvestProcess extends HarvestProcess  implements IndividualUriValue {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the HarvestProcess
	 */
	public ExternalHarvestProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalHarvestProcess
	 */
	public ExternalHarvestProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
			boolean create, String idPrefix) throws InvalidSPDXAnalysisException {
			super(modelStore, objectUri, copyManager, create, idPrefix);
	}

	/**
	 * Create the HarvestProcess from the builder - used in the builder class
	 * @param builder Builder to create the HarvestProcess from
	 * @throws InvalidSPDXAnalysisException when unable to create the HarvestProcess
	 */
	 @SuppressWarnings("unchecked")
	protected ExternalHarvestProcess(HarvestProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalHarvestProcess";
	}
	 ...
	 */
	public HarvestProcess setSuppliedBy(@Nullable Agent suppliedBy) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setCreationInfo(@Nullable CreationInfo creationInfo) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setProcessReadiness(@Nullable ProcessReadinessType processReadiness) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setIntendedUse(@Nullable String intendedUse) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setDescription(@Nullable String description) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setBuiltTime(@Nullable String builtTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the comment
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setComment(@Nullable String comment) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setProcessVersion(@Nullable String processVersion) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setValidUntilTime(@Nullable String validUntilTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setReleaseTime(@Nullable String releaseTime) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setProcessRationale(@Nullable String processRationale) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the name
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setName(@Nullable String name) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
		/**
	 * @return the summary
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public HarvestProcess setSummary(@Nullable String summary) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
