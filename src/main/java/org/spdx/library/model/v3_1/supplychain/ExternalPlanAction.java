...
/**
 * This is an external representation of PlanAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalPlanAction extends PlanAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalPlanAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalPlanAction
	 */
	public ExternalPlanAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalPlanAction(PlanActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalPlanAction";
	}
