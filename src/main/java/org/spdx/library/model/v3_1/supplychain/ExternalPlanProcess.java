...
/**
 * This is an external representation of PlanProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalPlanProcess extends PlanProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalPlanProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalPlanProcess
	 */
	public ExternalPlanProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalPlanProcess(PlanProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalPlanProcess";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public PlanProcess setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
