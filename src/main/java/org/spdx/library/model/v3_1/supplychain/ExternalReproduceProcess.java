...
/**
 * This is an external representation of ReproduceProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalReproduceProcess extends ReproduceProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalReproduceProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalReproduceProcess
	 */
	public ExternalReproduceProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalReproduceProcess(ReproduceProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalReproduceProcess";
	}
