...
/**
 * This is an external representation of State - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalState extends State  implements IndividualUriValue {
	 ...
	 */
	public ExternalState(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalState
	 */
	public ExternalState(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalState(StateBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalState";
	}
