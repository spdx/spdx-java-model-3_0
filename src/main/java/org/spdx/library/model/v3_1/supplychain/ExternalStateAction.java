...
/**
 * This is an external representation of StateAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalStateAction extends StateAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalStateAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalStateAction
	 */
	public ExternalStateAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalStateAction(StateActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalStateAction";
	}
