...
/**
 * This is an external representation of UseAction - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalUseAction extends UseAction  implements IndividualUriValue {
	 ...
	 */
	public ExternalUseAction(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalUseAction
	 */
	public ExternalUseAction(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalUseAction(UseActionBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalUseAction";
	}
	 ...
	 * @throws InvalidSPDXAnalysisException 
	 */
	public UseAction setExtension(@Nullable Extension extension) throws InvalidSPDXAnalysisException {
		throw new InvalidSPDXAnalysisException("External elements can not set properties");
	}
	/**
