...
/**
 * This is an external representation of UseProcess - nothing can be set and properties returned
 * are not valid
 *
 */
public class ExternalUseProcess extends UseProcess  implements IndividualUriValue {
	 ...
	 */
	public ExternalUseProcess(String objectUri) throws InvalidSPDXAnalysisException {
	 ...
	 * @throws InvalidSPDXAnalysisException when unable to create the ExternalUseProcess
	 */
	public ExternalUseProcess(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
	...
	protected ExternalUseProcess(UseProcessBuilder builder) throws InvalidSPDXAnalysisException {
		super(builder);
	}
	...
	public String getType() {
		return "SupplyChain.ExternalUseProcess";
	}
