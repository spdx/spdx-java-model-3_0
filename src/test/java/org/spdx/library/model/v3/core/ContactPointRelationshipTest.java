...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testContactPointRelationship.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.core.ContactPointRelationship#getExtension}.
	 */
	public void testContactPointRelationshipgetExtensions() throws InvalidSPDXAnalysisException {
		ContactPointRelationship testContactPointRelationship = generator.builderForContactPointRelationshipTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testContactPointRelationship.getExtensions())));
//		testContactPointRelationship.getExtensions().clear();
//		testContactPointRelationship.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testContactPointRelationship.getExtensions())));
		//TODO: Implement
	}
