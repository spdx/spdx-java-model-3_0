...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testRequirement.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.core.Requirement#getExtension}.
	 */
	public void testRequirementgetExtensions() throws InvalidSPDXAnalysisException {
		Requirement testRequirement = generator.builderForRequirementTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testRequirement.getExtensions())));
//		testRequirement.getExtensions().clear();
//		testRequirement.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testRequirement.getExtensions())));
		//TODO: Implement
	}
