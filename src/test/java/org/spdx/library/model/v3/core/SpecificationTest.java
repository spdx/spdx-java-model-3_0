...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSpecification.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.core.Specification#getExtension}.
	 */
	public void testSpecificationgetExtensions() throws InvalidSPDXAnalysisException {
		Specification testSpecification = generator.builderForSpecificationTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testSpecification.getExtensions())));
//		testSpecification.getExtensions().clear();
//		testSpecification.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSpecification.getExtensions())));
		//TODO: Implement
	}
