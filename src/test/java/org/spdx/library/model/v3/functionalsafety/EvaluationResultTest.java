...
public class EvaluationResultTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#Element(org.spdx.library.model.v3.functionalsafety.EvaluationResult.EvaluationResultBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#setEvaluationBasedOn}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testEvaluationResult.getEvaluationBasedOn());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testEvaluationResult.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#setEvaluation}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#setEvaluationRationale}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testEvaluationResult.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testEvaluationResult.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testEvaluationResult.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvaluationResult#getExtension}.
	 */
	public void testEvaluationResultgetExtensions() throws InvalidSPDXAnalysisException {
		EvaluationResult testEvaluationResult = generator.builderForEvaluationResultTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testEvaluationResult.getExtensions())));
//		testEvaluationResult.getExtensions().clear();
//		testEvaluationResult.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testEvaluationResult.getExtensions())));
		//TODO: Implement
	}
}
