...
public class EvidenceRelationshipTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#Element(org.spdx.library.model.v3.functionalsafety.EvidenceRelationship.EvidenceRelationshipBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setFrom}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testEvidenceRelationship.getFrom());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setEvidenceUUID}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testEvidenceRelationship.getEvidenceUUID());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testEvidenceRelationship.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setCompleteness}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setRelationshipType}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setStartTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setEndTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testEvidenceRelationship.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testEvidenceRelationship.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testEvidenceRelationship.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#getExtension}.
	 */
	public void testEvidenceRelationshipgetExtensions() throws InvalidSPDXAnalysisException {
		EvidenceRelationship testEvidenceRelationship = generator.builderForEvidenceRelationshipTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testEvidenceRelationship.getExtensions())));
//		testEvidenceRelationship.getExtensions().clear();
//		testEvidenceRelationship.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testEvidenceRelationship.getExtensions())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#getTo}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testEvidenceRelationship.getTos())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.EvidenceRelationship#getEvidenceCategory}.
	 */
