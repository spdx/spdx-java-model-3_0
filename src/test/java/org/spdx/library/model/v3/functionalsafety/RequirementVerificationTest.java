...
public class RequirementVerificationTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#Element(org.spdx.library.model.v3.functionalsafety.RequirementVerification.RequirementVerificationBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#setVerificationUUID}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testRequirementVerification.getVerificationUUID());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testRequirementVerification.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#setVerificationRationale}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testRequirementVerification.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testRequirementVerification.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testRequirementVerification.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#getExtension}.
	 */
	public void testRequirementVerificationgetExtensions() throws InvalidSPDXAnalysisException {
		RequirementVerification testRequirementVerification = generator.builderForRequirementVerificationTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testRequirementVerification.getExtensions())));
//		testRequirementVerification.getExtensions().clear();
//		testRequirementVerification.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testRequirementVerification.getExtensions())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#getVerificationPostconditions}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#getVerificationPreconditions}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.functionalsafety.RequirementVerification#getVerificationMethod}.
	 */
