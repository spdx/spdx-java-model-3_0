...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testBulkHardware.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.hardware.BulkHardware#getExtension}.
	 */
	public void testBulkHardwaregetExtensions() throws InvalidSPDXAnalysisException {
		BulkHardware testBulkHardware = generator.builderForBulkHardwareTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testBulkHardware.getExtensions())));
//		testBulkHardware.getExtensions().clear();
//		testBulkHardware.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testBulkHardware.getExtensions())));
		//TODO: Implement
	}
