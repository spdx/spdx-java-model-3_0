...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testPhysicalHardware.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.hardware.PhysicalHardware#getExtension}.
	 */
	public void testPhysicalHardwaregetExtensions() throws InvalidSPDXAnalysisException {
		PhysicalHardware testPhysicalHardware = generator.builderForPhysicalHardwareTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testPhysicalHardware.getExtensions())));
//		testPhysicalHardware.getExtensions().clear();
//		testPhysicalHardware.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testPhysicalHardware.getExtensions())));
		//TODO: Implement
	}
