...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testVirtualHardware.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.hardware.VirtualHardware#getExtension}.
	 */
	public void testVirtualHardwaregetExtensions() throws InvalidSPDXAnalysisException {
		VirtualHardware testVirtualHardware = generator.builderForVirtualHardwareTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testVirtualHardware.getExtensions())));
//		testVirtualHardware.getExtensions().clear();
//		testVirtualHardware.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testVirtualHardware.getExtensions())));
		//TODO: Implement
	}
