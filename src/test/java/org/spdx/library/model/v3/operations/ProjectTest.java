...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testProject.getElements())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.operations.Project#getExtension}.
	 */
	public void testProjectgetExtensions() throws InvalidSPDXAnalysisException {
		Project testProject = generator.builderForProjectTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testProject.getExtensions())));
//		testProject.getExtensions().clear();
//		testProject.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testProject.getExtensions())));
		//TODO: Implement
	}
