...
public class SoftwareServiceTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#Element(org.spdx.library.model.v3.service.SoftwareService.SoftwareServiceBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testSoftwareService.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#getProvider}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSoftwareService.getProviders())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSoftwareService.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSoftwareService.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSoftwareService.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#getExtension}.
	 */
	public void testSoftwareServicegetExtensions() throws InvalidSPDXAnalysisException {
		SoftwareService testSoftwareService = generator.builderForSoftwareServiceTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testSoftwareService.getExtensions())));
//		testSoftwareService.getExtensions().clear();
//		testSoftwareService.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSoftwareService.getExtensions())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#getServiceHostingCountrys}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.service.SoftwareService#getServerAuthenticationProtocol}.
	 */
