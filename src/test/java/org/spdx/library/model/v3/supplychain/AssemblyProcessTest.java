...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testAssemblyProcess.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.AssemblyProcess#getExtension}.
	 */
	public void testAssemblyProcessgetExtensions() throws InvalidSPDXAnalysisException {
		AssemblyProcess testAssemblyProcess = generator.builderForAssemblyProcessTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testAssemblyProcess.getExtensions())));
//		testAssemblyProcess.getExtensions().clear();
//		testAssemblyProcess.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testAssemblyProcess.getExtensions())));
		//TODO: Implement
	}
