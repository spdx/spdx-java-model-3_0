...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testBoundaryCrossingAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.BoundaryCrossingAction#getExtension}.
	 */
	public void testBoundaryCrossingActiongetExtensions() throws InvalidSPDXAnalysisException {
		BoundaryCrossingAction testBoundaryCrossingAction = generator.builderForBoundaryCrossingActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testBoundaryCrossingAction.getExtensions())));
//		testBoundaryCrossingAction.getExtensions().clear();
//		testBoundaryCrossingAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testBoundaryCrossingAction.getExtensions())));
		//TODO: Implement
	}
