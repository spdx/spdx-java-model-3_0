...
public class ChangeProcessTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#Element(org.spdx.library.model.v3.supplychain.ChangeProcess.ChangeProcessBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setSuppliedBy}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testChangeProcess.getSuppliedBy());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testChangeProcess.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setProcessReadiness}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setIntendedUse}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setBuiltTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setProcessVersion}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setValidUntilTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setReleaseTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setProcessRationale}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testChangeProcess.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testChangeProcess.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#getOriginatedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testChangeProcess.getOriginatedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testChangeProcess.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#getExtension}.
	 */
	public void testChangeProcessgetExtensions() throws InvalidSPDXAnalysisException {
		ChangeProcess testChangeProcess = generator.builderForChangeProcessTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testChangeProcess.getExtensions())));
//		testChangeProcess.getExtensions().clear();
//		testChangeProcess.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testChangeProcess.getExtensions())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#getStandardNames}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ChangeProcess#getSupportLevel}.
	 */
