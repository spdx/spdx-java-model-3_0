...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testCreateAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.CreateAction#getExtension}.
	 */
	public void testCreateActiongetExtensions() throws InvalidSPDXAnalysisException {
		CreateAction testCreateAction = generator.builderForCreateActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testCreateAction.getExtensions())));
//		testCreateAction.getExtensions().clear();
//		testCreateAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testCreateAction.getExtensions())));
		//TODO: Implement
	}
