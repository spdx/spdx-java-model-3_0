...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testCreateProcess.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.CreateProcess#getExtension}.
	 */
	public void testCreateProcessgetExtensions() throws InvalidSPDXAnalysisException {
		CreateProcess testCreateProcess = generator.builderForCreateProcessTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testCreateProcess.getExtensions())));
//		testCreateProcess.getExtensions().clear();
//		testCreateProcess.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testCreateProcess.getExtensions())));
		//TODO: Implement
	}
