...
public class DestroyActionTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#Element(org.spdx.library.model.v3.supplychain.DestroyAction.DestroyActionBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setSuppliedBy}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testDestroyAction.getSuppliedBy());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testDestroyAction.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setIntendedUse}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setBuiltTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setActionEndTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setValidUntilTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setReleaseTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#setActionStartTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getActionLocation}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyAction.getActionLocations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyAction.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyAction.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getOriginatedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyAction.getOriginatedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyAction.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getAdditionalInformation}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getExtension}.
	 */
	public void testDestroyActiongetExtensions() throws InvalidSPDXAnalysisException {
		DestroyAction testDestroyAction = generator.builderForDestroyActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testDestroyAction.getExtensions())));
//		testDestroyAction.getExtensions().clear();
//		testDestroyAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyAction.getExtensions())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getDestructionPerformedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyAction.getDestructionPerformedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getStandardNames}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyAction#getSupportLevel}.
	 */
