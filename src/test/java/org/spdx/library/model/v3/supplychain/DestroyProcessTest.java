...
public class DestroyProcessTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#Element(org.spdx.library.model.v3.supplychain.DestroyProcess.DestroyProcessBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setSuppliedBy}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testDestroyProcess.getSuppliedBy());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testDestroyProcess.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setProcessReadiness}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setIntendedUse}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setBuiltTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setProcessVersion}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setValidUntilTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setReleaseTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setProcessRationale}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyProcess.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyProcess.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#getOriginatedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyProcess.getOriginatedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyProcess.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#getExtension}.
	 */
	public void testDestroyProcessgetExtensions() throws InvalidSPDXAnalysisException {
		DestroyProcess testDestroyProcess = generator.builderForDestroyProcessTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testDestroyProcess.getExtensions())));
//		testDestroyProcess.getExtensions().clear();
//		testDestroyProcess.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testDestroyProcess.getExtensions())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#getStandardNames}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.DestroyProcess#getSupportLevel}.
	 */
