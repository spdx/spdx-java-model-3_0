...
public class ManufactureActionTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#Element(org.spdx.library.model.v3.supplychain.ManufactureAction.ManufactureActionBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setSuppliedBy}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testManufactureAction.getSuppliedBy());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testManufactureAction.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setIntendedUse}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setBuiltTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setActionEndTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setValidUntilTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setReleaseTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#setActionStartTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getActionLocation}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testManufactureAction.getActionLocations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testManufactureAction.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testManufactureAction.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getOriginatedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testManufactureAction.getOriginatedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testManufactureAction.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getAdditionalInformation}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testManufactureAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getExtension}.
	 */
	public void testManufactureActiongetExtensions() throws InvalidSPDXAnalysisException {
		ManufactureAction testManufactureAction = generator.builderForManufactureActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testManufactureAction.getExtensions())));
//		testManufactureAction.getExtensions().clear();
//		testManufactureAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testManufactureAction.getExtensions())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getStandardNames}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ManufactureAction#getSupportLevel}.
	 */
