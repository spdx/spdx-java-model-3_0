...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testOutOfSpecAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.OutOfSpecAction#getExtension}.
	 */
	public void testOutOfSpecActiongetExtensions() throws InvalidSPDXAnalysisException {
		OutOfSpecAction testOutOfSpecAction = generator.builderForOutOfSpecActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testOutOfSpecAction.getExtensions())));
//		testOutOfSpecAction.getExtensions().clear();
//		testOutOfSpecAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testOutOfSpecAction.getExtensions())));
		//TODO: Implement
	}
