...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testPlanAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.PlanAction#getExtension}.
	 */
	public void testPlanActiongetExtensions() throws InvalidSPDXAnalysisException {
		PlanAction testPlanAction = generator.builderForPlanActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testPlanAction.getExtensions())));
//		testPlanAction.getExtensions().clear();
//		testPlanAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testPlanAction.getExtensions())));
		//TODO: Implement
	}
