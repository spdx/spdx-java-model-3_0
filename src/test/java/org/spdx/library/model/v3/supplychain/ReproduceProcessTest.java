...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testReproduceProcess.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ReproduceProcess#getExtension}.
	 */
	public void testReproduceProcessgetExtensions() throws InvalidSPDXAnalysisException {
		ReproduceProcess testReproduceProcess = generator.builderForReproduceProcessTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testReproduceProcess.getExtensions())));
//		testReproduceProcess.getExtensions().clear();
//		testReproduceProcess.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testReproduceProcess.getExtensions())));
		//TODO: Implement
	}
