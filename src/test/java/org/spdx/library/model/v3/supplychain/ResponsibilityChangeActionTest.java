...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testResponsibilityChangeAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.ResponsibilityChangeAction#getExtension}.
	 */
	public void testResponsibilityChangeActiongetExtensions() throws InvalidSPDXAnalysisException {
		ResponsibilityChangeAction testResponsibilityChangeAction = generator.builderForResponsibilityChangeActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testResponsibilityChangeAction.getExtensions())));
//		testResponsibilityChangeAction.getExtensions().clear();
//		testResponsibilityChangeAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testResponsibilityChangeAction.getExtensions())));
		//TODO: Implement
	}
