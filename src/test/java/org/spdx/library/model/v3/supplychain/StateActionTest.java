...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testStateAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.StateAction#getExtension}.
	 */
	public void testStateActiongetExtensions() throws InvalidSPDXAnalysisException {
		StateAction testStateAction = generator.builderForStateActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testStateAction.getExtensions())));
//		testStateAction.getExtensions().clear();
//		testStateAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testStateAction.getExtensions())));
		//TODO: Implement
	}
