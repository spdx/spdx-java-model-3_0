...
public class StateTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#Element(org.spdx.library.model.v3.supplychain.State.StateBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setSuppliedBy}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testState.getSuppliedBy());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testState.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setIntendedUse}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setBuiltTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setValidUntilTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setReleaseTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testState.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testState.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#getOriginatedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testState.getOriginatedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testState.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#getExtension}.
	 */
	public void testStategetExtensions() throws InvalidSPDXAnalysisException {
		State testState = generator.builderForStateTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testState.getExtensions())));
//		testState.getExtensions().clear();
//		testState.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testState.getExtensions())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#getStandardNames}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.State#getSupportLevel}.
	 */
