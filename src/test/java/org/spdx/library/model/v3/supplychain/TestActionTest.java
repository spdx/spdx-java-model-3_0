...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testTestAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.TestAction#getExtension}.
	 */
	public void testTestActiongetExtensions() throws InvalidSPDXAnalysisException {
		TestAction testTestAction = generator.builderForTestActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testTestAction.getExtensions())));
//		testTestAction.getExtensions().clear();
//		testTestAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testTestAction.getExtensions())));
		//TODO: Implement
	}
