...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testTestProcess.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.TestProcess#getExtension}.
	 */
	public void testTestProcessgetExtensions() throws InvalidSPDXAnalysisException {
		TestProcess testTestProcess = generator.builderForTestProcessTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testTestProcess.getExtensions())));
//		testTestProcess.getExtensions().clear();
//		testTestProcess.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testTestProcess.getExtensions())));
		//TODO: Implement
	}
