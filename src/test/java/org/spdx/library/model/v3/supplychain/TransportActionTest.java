...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testTransportAction.getAdditionalInformations())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.supplychain.TransportAction#getExtension}.
	 */
	public void testTransportActiongetExtensions() throws InvalidSPDXAnalysisException {
		TransportAction testTransportAction = generator.builderForTransportActionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testTransportAction.getExtensions())));
//		testTransportAction.getExtensions().clear();
//		testTransportAction.getExtensions().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testTransportAction.getExtensions())));
		//TODO: Implement
	}
