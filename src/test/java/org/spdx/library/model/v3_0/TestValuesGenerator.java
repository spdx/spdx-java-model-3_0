...
import org.spdx.library.model.v3_0.ai.AIPackage.AIPackageBuilder;
import org.spdx.library.model.v3_0.ai.EnergyConsumption.EnergyConsumptionBuilder;
import org.spdx.library.model.v3_0.ai.EnergyConsumption;
import org.spdx.library.model.v3_0.ai.EnergyConsumptionDescription.EnergyConsumptionDescriptionBuilder;
import org.spdx.library.model.v3_0.ai.EnergyConsumptionDescription;
import org.spdx.library.model.v3_0.ai.EnergyUnitType;
import org.spdx.library.model.v3_0.ai.SafetyRiskAssessmentType;
import org.spdx.library.model.v3_0.build.Build.BuildBuilder;
import org.spdx.library.model.v3_0.core.Agent.AgentBuilder;
import org.spdx.library.model.v3_0.core.Agent;
import org.spdx.library.model.v3_0.core.Annotation.AnnotationBuilder;
import org.spdx.library.model.v3_0.core.AnnotationType;
import org.spdx.library.model.v3_0.core.Artifact.ArtifactBuilder;
import org.spdx.library.model.v3_0.core.Artifact;
import org.spdx.library.model.v3_0.core.Bom.BomBuilder;
import org.spdx.library.model.v3_0.core.Bundle.BundleBuilder;
import org.spdx.library.model.v3_0.core.CreationInfo.CreationInfoBuilder;
import org.spdx.library.model.v3_0.core.CreationInfo;
import org.spdx.library.model.v3_0.core.DictionaryEntry.DictionaryEntryBuilder;
import org.spdx.library.model.v3_0.core.DictionaryEntry;
import org.spdx.library.model.v3_0.core.Element.ElementBuilder;
import org.spdx.library.model.v3_0.core.Element;
import org.spdx.library.model.v3_0.core.ElementCollection.ElementCollectionBuilder;
import org.spdx.library.model.v3_0.core.ElementCollection;
import org.spdx.library.model.v3_0.core.ExternalIdentifier.ExternalIdentifierBuilder;
import org.spdx.library.model.v3_0.core.ExternalIdentifier;
import org.spdx.library.model.v3_0.core.ExternalIdentifierType;
import org.spdx.library.model.v3_0.core.ExternalMap.ExternalMapBuilder;
import org.spdx.library.model.v3_0.core.ExternalMap;
import org.spdx.library.model.v3_0.core.ExternalRef.ExternalRefBuilder;
import org.spdx.library.model.v3_0.core.ExternalRef;
import org.spdx.library.model.v3_0.core.ExternalRefType;
import org.spdx.library.model.v3_0.core.Hash.HashBuilder;
import org.spdx.library.model.v3_0.core.Hash;
import org.spdx.library.model.v3_0.core.HashAlgorithm;
import org.spdx.library.model.v3_0.core.IndividualElement.IndividualElementBuilder;
import org.spdx.library.model.v3_0.core.IntegrityMethod.IntegrityMethodBuilder;
import org.spdx.library.model.v3_0.core.IntegrityMethod;
import org.spdx.library.model.v3_0.core.LifecycleScopeType;
import org.spdx.library.model.v3_0.core.LifecycleScopedRelationship.LifecycleScopedRelationshipBuilder;
import org.spdx.library.model.v3_0.core.NamespaceMap.NamespaceMapBuilder;
import org.spdx.library.model.v3_0.core.NamespaceMap;
import org.spdx.library.model.v3_0.core.Organization.OrganizationBuilder;
import org.spdx.library.model.v3_0.core.PackageVerificationCode.PackageVerificationCodeBuilder;
import org.spdx.library.model.v3_0.core.Person.PersonBuilder;
import org.spdx.library.model.v3_0.core.PositiveIntegerRange.PositiveIntegerRangeBuilder;
import org.spdx.library.model.v3_0.core.PositiveIntegerRange;
import org.spdx.library.model.v3_0.core.PresenceType;
import org.spdx.library.model.v3_0.core.ProfileIdentifierType;
import org.spdx.library.model.v3_0.core.Relationship.RelationshipBuilder;
import org.spdx.library.model.v3_0.core.RelationshipCompleteness;
import org.spdx.library.model.v3_0.core.RelationshipType;
import org.spdx.library.model.v3_0.core.SoftwareAgent.SoftwareAgentBuilder;
import org.spdx.library.model.v3_0.core.SpdxDocument.SpdxDocumentBuilder;
import org.spdx.library.model.v3_0.core.SupportType;
import org.spdx.library.model.v3_0.core.Tool.ToolBuilder;
import org.spdx.library.model.v3_0.core.Tool;
import org.spdx.library.model.v3_0.dataset.ConfidentialityLevelType;
import org.spdx.library.model.v3_0.dataset.DatasetAvailabilityType;
import org.spdx.library.model.v3_0.dataset.DatasetPackage.DatasetPackageBuilder;
import org.spdx.library.model.v3_0.dataset.DatasetType;
import org.spdx.library.model.v3_0.expandedlicensing.ConjunctiveLicenseSet.ConjunctiveLicenseSetBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.CustomLicense.CustomLicenseBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.CustomLicenseAddition.CustomLicenseAdditionBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.DisjunctiveLicenseSet.DisjunctiveLicenseSetBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.ExtendableLicense.ExtendableLicenseBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.ExtendableLicense;
import org.spdx.library.model.v3_0.expandedlicensing.IndividualLicensingInfo.IndividualLicensingInfoBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.License.LicenseBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.License;
import org.spdx.library.model.v3_0.expandedlicensing.LicenseAddition.LicenseAdditionBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.LicenseAddition;
import org.spdx.library.model.v3_0.expandedlicensing.ListedLicense.ListedLicenseBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.ListedLicenseException.ListedLicenseExceptionBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.OrLaterOperator.OrLaterOperatorBuilder;
import org.spdx.library.model.v3_0.expandedlicensing.WithAdditionOperator.WithAdditionOperatorBuilder;
import org.spdx.library.model.v3_0.extension.CdxPropertiesExtension.CdxPropertiesExtensionBuilder;
import org.spdx.library.model.v3_0.extension.CdxPropertyEntry.CdxPropertyEntryBuilder;
import org.spdx.library.model.v3_0.extension.CdxPropertyEntry;
...
import org.spdx.library.model.v3_0.security.CvssSeverityType;
import org.spdx.library.model.v3_0.security.CvssV2VulnAssessmentRelationship.CvssV2VulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.CvssV3VulnAssessmentRelationship.CvssV3VulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.CvssV4VulnAssessmentRelationship.CvssV4VulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.EpssVulnAssessmentRelationship.EpssVulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.ExploitCatalogType;
import org.spdx.library.model.v3_0.security.ExploitCatalogVulnAssessmentRelationship.ExploitCatalogVulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.SsvcDecisionType;
import org.spdx.library.model.v3_0.security.SsvcVulnAssessmentRelationship.SsvcVulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.VexAffectedVulnAssessmentRelationship.VexAffectedVulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.VexFixedVulnAssessmentRelationship.VexFixedVulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.VexJustificationType;
import org.spdx.library.model.v3_0.security.VexNotAffectedVulnAssessmentRelationship.VexNotAffectedVulnAssessmentRelationshipBuilder;
...
import org.spdx.library.model.v3_0.security.VexVulnAssessmentRelationship.VexVulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.VexVulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.VulnAssessmentRelationship.VulnAssessmentRelationshipBuilder;
import org.spdx.library.model.v3_0.security.VulnAssessmentRelationship;
import org.spdx.library.model.v3_0.security.Vulnerability.VulnerabilityBuilder;
import org.spdx.library.model.v3_0.simplelicensing.AnyLicenseInfo.AnyLicenseInfoBuilder;
import org.spdx.library.model.v3_0.simplelicensing.AnyLicenseInfo;
import org.spdx.library.model.v3_0.simplelicensing.LicenseExpression.LicenseExpressionBuilder;
import org.spdx.library.model.v3_0.simplelicensing.SimpleLicensingText.SimpleLicensingTextBuilder;
import org.spdx.library.model.v3_0.software.ContentIdentifier.ContentIdentifierBuilder;
import org.spdx.library.model.v3_0.software.ContentIdentifier;
import org.spdx.library.model.v3_0.software.ContentIdentifierType;
import org.spdx.library.model.v3_0.software.FileKindType;
import org.spdx.library.model.v3_0.software.Sbom.SbomBuilder;
import org.spdx.library.model.v3_0.software.SbomType;
import org.spdx.library.model.v3_0.software.Snippet.SnippetBuilder;
import org.spdx.library.model.v3_0.software.SoftwareArtifact.SoftwareArtifactBuilder;
import org.spdx.library.model.v3_0.software.SoftwareArtifact;
import org.spdx.library.model.v3_0.software.SoftwarePurpose;
import org.spdx.library.model.v3_0.software.SpdxFile.SpdxFileBuilder;
import org.spdx.library.model.v3_0.software.SpdxFile;
import org.spdx.library.model.v3_0.software.SpdxPackage.SpdxPackageBuilder;
...
public class TestValuesGenerator {
	...
	public TestValuesGenerator(IModelStore modelStore, IModelCopyManager copyManager) throws InvalidSPDXAnalysisException {
		...
		if (!ModelRegistry.getModelRegistry().containsSpecVersion("v3_0")) {
	...
	public SsvcVulnAssessmentRelationshipBuilder builderForSsvcVulnAssessmentRelationshipTests(String objectUri) throws InvalidSPDXAnalysisException {
		SsvcVulnAssessmentRelationshipBuilder retval = new SsvcVulnAssessmentRelationshipBuilder(modelStore, objectUri, copyManager)
				...
				.setExtension(builderForExtensionTests(modelStore.getNextId(IdType.SpdxId)).build())
				.setAssessedElement(builderForSoftwareArtifactTests(modelStore.getNextId(IdType.SpdxId)).build())
