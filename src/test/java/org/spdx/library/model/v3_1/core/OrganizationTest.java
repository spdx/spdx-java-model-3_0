...
public class OrganizationTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#Element(org.spdx.library.model.v3_1.core.Organization.OrganizationBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#setExtension}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testOrganization.getExtension());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testOrganization.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#getHeadquartersLocation}.
	 */
	public void testOrganizationgetHeadquartersLocations() throws InvalidSPDXAnalysisException {
		Organization testOrganization = generator.builderForOrganizationTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testOrganization.getHeadquartersLocations())));
//		testOrganization.getHeadquartersLocations().clear();
//		testOrganization.getHeadquartersLocations().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testOrganization.getHeadquartersLocations())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testOrganization.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testOrganization.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.core.Organization#getExternalRef}.
	 */
