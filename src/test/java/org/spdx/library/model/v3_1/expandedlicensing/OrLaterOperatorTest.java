...
public class OrLaterOperatorTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#Element(org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator.OrLaterOperatorBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#setSubjectLicense}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testOrLaterOperator.getSubjectLicense());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#setExtension}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testOrLaterOperator.getExtension());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testOrLaterOperator.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testOrLaterOperator.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testOrLaterOperator.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.expandedlicensing.OrLaterOperator#getExternalRef}.
	 */
