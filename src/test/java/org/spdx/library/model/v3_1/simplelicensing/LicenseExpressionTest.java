 ...
 */
package org.spdx.library.model.v3_1.simplelicensing;
...
public class LicenseExpressionTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#Element(org.spdx.library.model.v3_1.simplelicensing.LicenseExpression.LicenseExpressionBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#setExtension}.
	 */
	public void testLicenseExpressionsetExtension() throws InvalidSPDXAnalysisException {
		LicenseExpression testLicenseExpression = generator.builderForLicenseExpressionTests(TEST_OBJECT_URI).build();
//		assertEquals(Optional.of(TEST_VALUE), testLicenseExpression.getExtension());
//		testLicenseExpression.setExtension(NEW_TEST_VALUE);
//		assertEquals(Optional.of(NEW_TEST_VALUE), testLicenseExpression.getExtension());
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testLicenseExpression.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#setLicenseExpression}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#setLicenseListVersion}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#getCustomIdToLicense}.
	 */
	public void testLicenseExpressiongetCustomIdToLicenses() throws InvalidSPDXAnalysisException {
		LicenseExpression testLicenseExpression = generator.builderForLicenseExpressionTests(TEST_OBJECT_URI).build();
//		assertTrue(UnitTestHelper.isListsEquivalent(TEST_VALUE, new ArrayList<>(testLicenseExpression.getCustomIdToLicenses())));
//		testLicenseExpression.getCustomIdToLicenses().clear();
//		testLicenseExpression.getCustomIdToLicenses().addAll(NEW_TEST_VALUE);
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testLicenseExpression.getCustomIdToLicenses())));
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testLicenseExpression.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#getCustomIdToUri}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testLicenseExpression.getCustomIdToUris())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testLicenseExpression.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.simplelicensing.LicenseExpression#getExternalIdentifier}.
	 */
