...
public class SpdxFileTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#Element(org.spdx.library.model.v3_1.software.SpdxFile.SpdxFileBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setSuppliedBy}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testSpdxFile.getSuppliedBy());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setExtension}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testSpdxFile.getExtension());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testSpdxFile.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setPrimaryPurpose}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setFileKind}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setArtifactSize}.
	 */
	public void testSpdxFilesetArtifactSize() throws InvalidSPDXAnalysisException {
		SpdxFile testSpdxFile = generator.builderForSpdxFileTests(TEST_OBJECT_URI).build();
		assertEquals(Optional.of(TestValuesGenerator.ARTIFACT_SIZE_TEST_VALUE), testSpdxFile.getArtifactSize());
		testSpdxFile.setArtifactSize(new Integer(653));
		assertEquals(Optional.of(new Integer(653)), testSpdxFile.getArtifactSize());
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setIntendedUse}.
	 */
	public void testSpdxFilesetIntendedUse() throws InvalidSPDXAnalysisException {
		SpdxFile testSpdxFile = generator.builderForSpdxFileTests(TEST_OBJECT_URI).build();
		assertEquals(Optional.of(TestValuesGenerator.INTENDED_USE_TEST_VALUE), testSpdxFile.getIntendedUse());
		String newStringValue = "new intendedUse value";
		testSpdxFile.setIntendedUse(newStringValue);
		assertEquals(Optional.of(newStringValue), testSpdxFile.getIntendedUse());
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setBuiltTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setValidUntilTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setCopyrightText}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setReleaseTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setContentType}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSpdxFile.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getContentIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSpdxFile.getContentIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSpdxFile.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getOriginatedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSpdxFile.getOriginatedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testSpdxFile.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getAttributionTexts}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getStandardNames}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getAdditionalPurpose}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.software.SpdxFile#getSupportLevel}.
	 */
