...
public class ModifyProcessTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#Element(org.spdx.library.model.v3_1.supplychain.ModifyProcess.ModifyProcessBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setSuppliedBy}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testModifyProcess.getSuppliedBy());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setExtension}.
	 */
	public void testModifyProcesssetExtension() throws InvalidSPDXAnalysisException {
		ModifyProcess testModifyProcess = generator.builderForModifyProcessTests(TEST_OBJECT_URI).build();
//		assertEquals(Optional.of(TEST_VALUE), testModifyProcess.getExtension());
//		testModifyProcess.setExtension(NEW_TEST_VALUE);
//		assertEquals(Optional.of(NEW_TEST_VALUE), testModifyProcess.getExtension());
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testModifyProcess.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setProcessReadiness}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setIntendedUse}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setBuiltTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setProcessVersion}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setValidUntilTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setReleaseTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setProcessRationale}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testModifyProcess.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testModifyProcess.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#getOriginatedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testModifyProcess.getOriginatedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testModifyProcess.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#getStandardNames}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.ModifyProcess#getSupportLevel}.
	 */
