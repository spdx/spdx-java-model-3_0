...
public class PlanProcessTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#Element(org.spdx.library.model.v3_1.supplychain.PlanProcess.PlanProcessBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setSuppliedBy}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testPlanProcess.getSuppliedBy());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setExtension}.
	 */
	public void testPlanProcesssetExtension() throws InvalidSPDXAnalysisException {
		PlanProcess testPlanProcess = generator.builderForPlanProcessTests(TEST_OBJECT_URI).build();
//		assertEquals(Optional.of(TEST_VALUE), testPlanProcess.getExtension());
//		testPlanProcess.setExtension(NEW_TEST_VALUE);
//		assertEquals(Optional.of(NEW_TEST_VALUE), testPlanProcess.getExtension());
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testPlanProcess.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setProcessReadiness}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setIntendedUse}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setBuiltTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setProcessVersion}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setValidUntilTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setReleaseTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setProcessRationale}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testPlanProcess.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testPlanProcess.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#getOriginatedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testPlanProcess.getOriginatedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testPlanProcess.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#getStandardNames}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.PlanProcess#getSupportLevel}.
	 */
