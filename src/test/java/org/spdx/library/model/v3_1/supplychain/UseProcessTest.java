...
public class UseProcessTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#getType()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#Element(org.spdx.library.model.v3_1.supplychain.UseProcess.UseProcessBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setSuppliedBy}.
	 */
...
//		assertEquals(Optional.of(NEW_TEST_VALUE), testUseProcess.getSuppliedBy());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setExtension}.
	 */
	public void testUseProcesssetExtension() throws InvalidSPDXAnalysisException {
		UseProcess testUseProcess = generator.builderForUseProcessTests(TEST_OBJECT_URI).build();
//		assertEquals(Optional.of(TEST_VALUE), testUseProcess.getExtension());
//		testUseProcess.setExtension(NEW_TEST_VALUE);
//		assertEquals(Optional.of(NEW_TEST_VALUE), testUseProcess.getExtension());
		//TODO: Implement
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setCreationInfo}.
	 */
...
//		assertEquals(NEW_TEST_VALUE, testUseProcess.getCreationInfo());
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setProcessReadiness}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setIntendedUse}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setDescription}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setBuiltTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setComment}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setProcessVersion}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setValidUntilTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setReleaseTime}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setProcessRationale}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setName}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#setSummary}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#getVerifiedUsing}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testUseProcess.getVerifiedUsings())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#getExternalRef}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testUseProcess.getExternalRefs())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#getOriginatedBy}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testUseProcess.getOriginatedBys())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#getExternalIdentifier}.
	 */
...
//		assertTrue(UnitTestHelper.isListsEquivalent(NEW_TEST_VALUE, new ArrayList<>(testUseProcess.getExternalIdentifiers())));
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#getStandardNames}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3_1.supplychain.UseProcess#getSupportLevel}.
	 */
